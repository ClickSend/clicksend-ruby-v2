...
| **messages** | [**Array&lt;SendSmsRequestMessagesInner&gt;**](SendSmsRequestMessagesInner.md) | Messages to send to customers. | [optional] |
...
instance = ClickSend::SendSmsRequest.new(
  senders: null,
  shorten_urls: null,
  messages: null
)
