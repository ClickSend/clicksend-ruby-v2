...
| **data** | [**Array&lt;InboundSms&gt;**](InboundSms.md) | The parameters related to the actual inbound SMS. | [optional] |
...
instance = ClickSend::ViewInboundSmsData.new(
  total: 2,
  per_page: 15,
  current_page: 1,
  last_page: 1,
