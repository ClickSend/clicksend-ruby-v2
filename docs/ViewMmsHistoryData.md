...
| **data** | [**Array&lt;ViewMmsHistoryDataAllOfDataInner&gt;**](ViewMmsHistoryDataAllOfDataInner.md) |  | [optional] |
...
instance = ClickSend::ViewMmsHistoryData.new(
  total: 2,
  per_page: 15,
  current_page: 1,
  last_page: 1,
