# ClickSend::ViewSmsCampaignsData
...
| **data** | [**Array&lt;SmsCampaign&gt;**](SmsCampaign.md) | The parameters related to the SMS campaign. | [optional] |
...
instance = ClickSend::ViewSmsCampaignsData.new(
  total: 2,
  per_page: 15,
  current_page: 1,
  last_page: 1,
