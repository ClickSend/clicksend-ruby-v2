...
| **data** | [**Array&lt;ViewSmsHistoryDataAllOfDataInner&gt;**](ViewSmsHistoryDataAllOfDataInner.md) | The parameters related to the actual SMS. | [optional] |
...
instance = ClickSend::ViewSmsHistoryData.new(
  total: 2,
  per_page: 15,
  current_page: 1,
  last_page: 1,
