...
| **data** | [**Array&lt;SmsReceipt&gt;**](SmsReceipt.md) | The parameters related to the actual message receipts. | [optional] |
...
instance = ClickSend::ViewSmsReceiptsData.new(
  total: 2,
  per_page: 15,
  current_page: 1,
  last_page: 1,
