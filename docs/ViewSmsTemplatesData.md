# ClickSend::ViewSmsTemplatesData
...
| **data** | [**Array&lt;SmsTemplate&gt;**](SmsTemplate.md) | The parameters related to the actual templates. | [optional] |
...
instance = ClickSend::ViewSmsTemplatesData.new(
  total: 2,
  per_page: 15,
  current_page: 1,
  last_page: 1,
