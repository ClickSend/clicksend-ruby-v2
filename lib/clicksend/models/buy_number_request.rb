...
module ClickSend
  class BuyNumberRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'type' => :'String',
        :'registration_data' => :'BuyNumberRequestRegistrationData'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClickSend::BuyNumberRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClickSend::BuyNumberRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'registration_data')
        self.registration_data = attributes[:'registration_data']
      end
    end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["sms", "mms"])
      return false unless type_validator.valid?(@type)
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] dedicated_number Value to be assigned
    def dedicated_number=(dedicated_number)
      if dedicated_number.nil?
        fail ArgumentError, 'dedicated_number cannot be nil'
      end
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["sms", "mms"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          type == o.type &&
          registration_data == o.registration_data
    end
    ...
    def hash
      [dedicated_number, type, registration_data].hash
    end
