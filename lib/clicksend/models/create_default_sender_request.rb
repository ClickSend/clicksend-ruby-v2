...
module ClickSend
  class CreateDefaultSenderRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        :'country_code' => :'String',
        :'product_type' => :'String',
        :'default_sender_strategies' => :'Array<CreateDefaultSenderRequestDefaultSenderStrategiesInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClickSend::CreateDefaultSenderRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClickSend::CreateDefaultSenderRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @default_sender_strategies.length > 1
        invalid_properties.push('invalid value for "default_sender_strategies", number of items must be less than or equal to 1.')
      end
    ...
    def default_sender_strategies=(default_sender_strategies)
      ...
      if default_sender_strategies.length > 1
        fail ArgumentError, 'invalid value for "default_sender_strategies", number of items must be less than or equal to 1.'
      end
    ...
    def hash
      [country_code, product_type, default_sender_strategies].hash
    end
