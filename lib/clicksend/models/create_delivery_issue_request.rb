...
module ClickSend
  class CreateDeliveryIssueRequest < ApiModelBase
    ...
    attr_accessor :support_comments
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClickSend::CreateDeliveryIssueRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClickSend::CreateDeliveryIssueRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'client_comments')
        self.client_comments = attributes[:'client_comments']
      end

      if attributes.key?(:'support_comments')
        self.support_comments = attributes[:'support_comments']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          support_comments == o.support_comments &&
          resolved == o.resolved
    end
    ...
    def hash
      [message_id, type, description, email_address, client_comments, support_comments, resolved].hash
    end
