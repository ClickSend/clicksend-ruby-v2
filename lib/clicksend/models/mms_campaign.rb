...
module ClickSend
  class MmsCampaign < ApiModelBase
    # The ID of the MMS campaign.
    attr_accessor :mms_campaign_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClickSend::MmsCampaign` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClickSend::MmsCampaign`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'mms_campaign_id')
        self.mms_campaign_id = attributes[:'mms_campaign_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          mms_campaign_id == o.mms_campaign_id &&
          name == o.name &&
          user_id == o.user_id &&
    ...
    def hash
      [mms_campaign_id, name, user_id, subaccount_id, list_id, from, subject, file_name, body, schedule, status, date_added, _total_count, _list_name, _media_file_url].hash
    end
