...
module ClickSend
  class SmsInboundRule < ApiModelBase
    # The ID of the inbound rule.
    attr_accessor :inbound_rule_id
    ...
    def self.openapi_types
      {
        :'inbound_rule_id' => :'Integer',
        :'dedicated_number' => :'String',
        :'rule_name' => :'String',
        :'message_search_type' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClickSend::SmsInboundRule` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClickSend::SmsInboundRule`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'inbound_rule_id')
        self.inbound_rule_id = attributes[:'inbound_rule_id']
      end
      ...
      if attributes.key?(:'message_search_type')
        self.message_search_type = attributes[:'message_search_type']
      end

      if attributes.key?(:'message_search_term')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          inbound_rule_id == o.inbound_rule_id &&
