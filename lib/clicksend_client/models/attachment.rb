...
module ClickSend
  class Attachment < ApiModelBase
    ...
    attr_accessor :_attachment_file_url
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClickSend::Attachment` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClickSend::Attachment`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_attachment_file_url')
        self._attachment_file_url = attributes[:'_attachment_file_url']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _attachment_file_url == o._attachment_file_url
    end
    ...
    def hash
      [file_name, content_type, content_disposition, content_id, _attachment_file_url].hash
    end
