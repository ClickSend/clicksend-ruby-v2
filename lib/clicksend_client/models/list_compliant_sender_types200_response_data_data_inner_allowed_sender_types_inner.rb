...
module ClickSend
  class ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner < ApiModelBase
    # Type of sender
    attr_accessor :sender_type

    attr_accessor :allowed_sender_countries
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClickSend::ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClickSend::ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'allowed_sender_countries')
        self.allowed_sender_countries = attributes[:'allowed_sender_countries']
      else
        self.allowed_sender_countries = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @allowed_sender_countries.nil?
        invalid_properties.push('invalid value for "allowed_sender_countries", allowed_sender_countries cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @allowed_sender_countries.nil?
      true
    end
    ...
    # @param [Object] allowed_sender_countries Value to be assigned
    def allowed_sender_countries=(allowed_sender_countries)
      if allowed_sender_countries.nil?
        fail ArgumentError, 'allowed_sender_countries cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          allowed_sender_countries == o.allowed_sender_countries
    end
    ...
    def hash
      [sender_type, allowed_sender_countries].hash
    end
