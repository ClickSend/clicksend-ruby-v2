...
module ClickSend
  class PurchaseDedicatedNumberData < ApiModelBase
    ...
    attr_accessor :_price_setup

    # The monthly price of the new dedicated number.
    attr_accessor :_price_monthly
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClickSend::PurchaseDedicatedNumberData` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClickSend::PurchaseDedicatedNumberData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'_price_setup')
        self._price_setup = attributes[:'_price_setup']
      end

      if attributes.key?(:'_price_monthly')
        self._price_monthly = attributes[:'_price_monthly']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          _price_setup == o._price_setup &&
          _price_monthly == o._price_monthly &&
    ...
    def hash
      [dedicated_number, country, price_total, _price_setup, _price_monthly, _currency].hash
    end
