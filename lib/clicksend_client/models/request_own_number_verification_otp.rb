...
module ClickSend
  class RequestOwnNumberVerificationOtp < ApiModelBase
    # The ID of the verification request.
    attr_accessor :id

    # The ID of the own number.
    attr_accessor :own_number_id
    ...
    attr_accessor :remaining_attempts
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClickSend::RequestOwnNumberVerificationOtp` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClickSend::RequestOwnNumberVerificationOtp`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'own_number_id')
        self.own_number_id = attributes[:'own_number_id']
      end
      ...
      if attributes.key?(:'remaining_attempts')
        self.remaining_attempts = attributes[:'remaining_attempts']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          own_number_id == o.own_number_id &&
          status == o.status &&
          expires_timestamp == o.expires_timestamp &&
          remaining_attempts == o.remaining_attempts &&
    ...
    def hash
      [id, own_number_id, status, expires_timestamp, remaining_attempts, created_timestamp, updated_timestamp].hash
    end
