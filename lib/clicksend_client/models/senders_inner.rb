...
module ClickSend
  class SendersInner < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClickSend::SendersInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClickSend::SendersInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      sender_type_validator = EnumAttributeValidator.new('String', ["shared_longcode"])
    ...
    def sender_type=(sender_type)
      validator = EnumAttributeValidator.new('String', ["shared_longcode"])
    ...
    def hash
      [recipient_country_code, sender_id, sender_type, sender_country_code].hash
    end
