...
module ClickSend
  class ViewReferralAccountsDataAllOfDataInner < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClickSend::ViewReferralAccountsDataAllOfDataInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClickSend::ViewReferralAccountsDataAllOfDataInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'referral_rule_id')
        self.referral_rule_id = attributes[:'referral_rule_id']
      end

      if attributes.key?(:'refered_user_id')
        self.refered_user_id = attributes[:'refered_user_id']
      end

      if attributes.key?(:'date_referred')
        self.date_referred = attributes[:'date_referred']
      end

      if attributes.key?(:'percentage_referral')
        self.percentage_referral = attributes[:'percentage_referral']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          referral_rule_id == o.referral_rule_id &&
          refered_user_id == o.refered_user_id &&
          date_referred == o.date_referred &&
          percentage_referral == o.percentage_referral
    end
    ...
    def hash
      [referral_rule_id, refered_user_id, date_referred, percentage_referral].hash
    end
