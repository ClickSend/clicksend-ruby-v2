...
module ClickSend
  class ViewStrippedStringRuleData < ApiModelBase
    # The rule id
    attr_accessor :rule_id

    # The string to be stripped
    attr_accessor :stripped_string
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClickSend::ViewStrippedStringRuleData` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClickSend::ViewStrippedStringRuleData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'stripped_string')
        self.stripped_string = attributes[:'stripped_string']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          rule_id == o.rule_id &&
          stripped_string == o.stripped_string
    end
