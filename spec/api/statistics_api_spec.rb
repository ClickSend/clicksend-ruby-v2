...
# Unit tests for ClickSend::StatisticsApi
...
describe 'StatisticsApi' do
  ...
  describe 'test an instance of StatisticsApi' do
    it 'should create an instance of StatisticsApi' do
      expect(@api_instance).to be_instance_of(ClickSend::StatisticsApi)
    end
  end

  # unit tests for view_sms_statistics
  # View SMS Statistics
  ...
  describe 'view_sms_statistics test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for view_voice_statistics
  ...
  describe 'view_voice_statistics test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
