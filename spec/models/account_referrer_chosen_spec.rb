...
# Unit tests for ClickSend::AccountReferrerChosen
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::AccountReferrerChosen do
  #let(:instance) { ClickSend::AccountReferrerChosen.new }

  describe 'test an instance of AccountReferrerChosen' do
    it 'should create an instance of AccountReferrerChosen' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::AccountReferrerChosen)
    end
  end
