...
# Unit tests for ClickSend::AddAllowedEmailData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::AddAllowedEmailData do
  #let(:instance) { ClickSend::AddAllowedEmailData.new }

  describe 'test an instance of AddAllowedEmailData' do
    it 'should create an instance of AddAllowedEmailData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::AddAllowedEmailData)
    end
  end
