...
# Unit tests for ClickSend::AddAllowedEmailRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::AddAllowedEmailRequest do
  #let(:instance) { ClickSend::AddAllowedEmailRequest.new }

  describe 'test an instance of AddAllowedEmailRequest' do
    it 'should create an instance of AddAllowedEmailRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::AddAllowedEmailRequest)
    end
  end
