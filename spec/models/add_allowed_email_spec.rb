...
# Unit tests for ClickSend::AddAllowedEmail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::AddAllowedEmail do
  #let(:instance) { ClickSend::AddAllowedEmail.new }

  describe 'test an instance of AddAllowedEmail' do
    it 'should create an instance of AddAllowedEmail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::AddAllowedEmail)
    end
  end
