...
# Unit tests for ClickSend::AgreeToRulesAndRegulation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::AgreeToRulesAndRegulation do
  #let(:instance) { ClickSend::AgreeToRulesAndRegulation.new }

  describe 'test an instance of AgreeToRulesAndRegulation' do
    it 'should create an instance of AgreeToRulesAndRegulation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::AgreeToRulesAndRegulation)
    end
  end
