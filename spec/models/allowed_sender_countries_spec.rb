...
# Unit tests for ClickSend::AllowedSenderCountries
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::AllowedSenderCountries do
  #let(:instance) { ClickSend::AllowedSenderCountries.new }

  describe 'test an instance of AllowedSenderCountries' do
    it 'should create an instance of AllowedSenderCountries' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::AllowedSenderCountries)
    end
  end
