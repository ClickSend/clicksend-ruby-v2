...
# Unit tests for ClickSend::AlphaTag
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::AlphaTag do
  #let(:instance) { ClickSend::AlphaTag.new }

  describe 'test an instance of AlphaTag' do
    it 'should create an instance of AlphaTag' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::AlphaTag)
    end
  end
