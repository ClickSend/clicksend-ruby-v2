...
# Unit tests for ClickSend::Attachment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::Attachment do
  #let(:instance) { ClickSend::Attachment.new }

  describe 'test an instance of Attachment' do
    it 'should create an instance of Attachment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::Attachment)
    end
  end
  ...
  describe 'test attribute "_attachment_file_url"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
