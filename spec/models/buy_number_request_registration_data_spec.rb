...
# Unit tests for ClickSend::BuyNumberRequestRegistrationData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::BuyNumberRequestRegistrationData do
  #let(:instance) { ClickSend::BuyNumberRequestRegistrationData.new }

  describe 'test an instance of BuyNumberRequestRegistrationData' do
    it 'should create an instance of BuyNumberRequestRegistrationData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::BuyNumberRequestRegistrationData)
    end
  end
