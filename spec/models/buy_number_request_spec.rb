...
# Unit tests for ClickSend::BuyNumberRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::BuyNumberRequest do
  #let(:instance) { ClickSend::BuyNumberRequest.new }

  describe 'test an instance of BuyNumberRequest' do
    it 'should create an instance of BuyNumberRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::BuyNumberRequest)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["sms", "mms"])
  ...
  describe 'test attribute "registration_data"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
