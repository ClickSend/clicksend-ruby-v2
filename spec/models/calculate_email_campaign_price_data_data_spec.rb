...
# Unit tests for ClickSend::CalculateEmailCampaignPriceDataData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateEmailCampaignPriceDataData do
  #let(:instance) { ClickSend::CalculateEmailCampaignPriceDataData.new }

  describe 'test an instance of CalculateEmailCampaignPriceDataData' do
    it 'should create an instance of CalculateEmailCampaignPriceDataData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateEmailCampaignPriceDataData)
    end
  end
