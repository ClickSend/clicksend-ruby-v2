...
# Unit tests for ClickSend::CalculateEmailCampaignPriceData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateEmailCampaignPriceData do
  #let(:instance) { ClickSend::CalculateEmailCampaignPriceData.new }

  describe 'test an instance of CalculateEmailCampaignPriceData' do
    it 'should create an instance of CalculateEmailCampaignPriceData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateEmailCampaignPriceData)
    end
  end
