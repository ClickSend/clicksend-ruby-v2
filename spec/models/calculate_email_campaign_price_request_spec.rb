...
# Unit tests for ClickSend::CalculateEmailCampaignPriceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateEmailCampaignPriceRequest do
  #let(:instance) { ClickSend::CalculateEmailCampaignPriceRequest.new }

  describe 'test an instance of CalculateEmailCampaignPriceRequest' do
    it 'should create an instance of CalculateEmailCampaignPriceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateEmailCampaignPriceRequest)
    end
  end
