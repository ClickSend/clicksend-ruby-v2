...
# Unit tests for ClickSend::CalculateEmailCampaignPrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateEmailCampaignPrice do
  #let(:instance) { ClickSend::CalculateEmailCampaignPrice.new }

  describe 'test an instance of CalculateEmailCampaignPrice' do
    it 'should create an instance of CalculateEmailCampaignPrice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateEmailCampaignPrice)
    end
  end
