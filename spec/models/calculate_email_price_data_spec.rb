...
# Unit tests for ClickSend::CalculateEmailPriceData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateEmailPriceData do
  #let(:instance) { ClickSend::CalculateEmailPriceData.new }

  describe 'test an instance of CalculateEmailPriceData' do
    it 'should create an instance of CalculateEmailPriceData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateEmailPriceData)
    end
  end
