...
# Unit tests for ClickSend::CalculateEmailPriceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateEmailPriceRequest do
  #let(:instance) { ClickSend::CalculateEmailPriceRequest.new }

  describe 'test an instance of CalculateEmailPriceRequest' do
    it 'should create an instance of CalculateEmailPriceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateEmailPriceRequest)
    end
  end
