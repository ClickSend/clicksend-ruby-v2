...
# Unit tests for ClickSend::CalculateEmailPrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateEmailPrice do
  #let(:instance) { ClickSend::CalculateEmailPrice.new }

  describe 'test an instance of CalculateEmailPrice' do
    it 'should create an instance of CalculateEmailPrice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateEmailPrice)
    end
  end
