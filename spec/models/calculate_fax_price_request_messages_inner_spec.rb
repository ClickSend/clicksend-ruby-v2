...
# Unit tests for ClickSend::CalculateFaxPriceRequestMessagesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateFaxPriceRequestMessagesInner do
  #let(:instance) { ClickSend::CalculateFaxPriceRequestMessagesInner.new }

  describe 'test an instance of CalculateFaxPriceRequestMessagesInner' do
    it 'should create an instance of CalculateFaxPriceRequestMessagesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateFaxPriceRequestMessagesInner)
    end
  end
