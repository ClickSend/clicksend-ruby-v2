...
# Unit tests for ClickSend::CalculateFaxPriceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateFaxPriceRequest do
  #let(:instance) { ClickSend::CalculateFaxPriceRequest.new }

  describe 'test an instance of CalculateFaxPriceRequest' do
    it 'should create an instance of CalculateFaxPriceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateFaxPriceRequest)
    end
  end
