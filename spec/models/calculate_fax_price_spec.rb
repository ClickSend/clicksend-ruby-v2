...
# Unit tests for ClickSend::CalculateFaxPrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateFaxPrice do
  #let(:instance) { ClickSend::CalculateFaxPrice.new }

  describe 'test an instance of CalculateFaxPrice' do
    it 'should create an instance of CalculateFaxPrice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateFaxPrice)
    end
  end
