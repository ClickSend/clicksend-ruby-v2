...
# Unit tests for ClickSend::CalculateLetterPriceData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateLetterPriceData do
  #let(:instance) { ClickSend::CalculateLetterPriceData.new }

  describe 'test an instance of CalculateLetterPriceData' do
    it 'should create an instance of CalculateLetterPriceData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateLetterPriceData)
    end
  end
