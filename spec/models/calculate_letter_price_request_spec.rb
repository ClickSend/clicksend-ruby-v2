...
# Unit tests for ClickSend::CalculateLetterPriceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateLetterPriceRequest do
  #let(:instance) { ClickSend::CalculateLetterPriceRequest.new }

  describe 'test an instance of CalculateLetterPriceRequest' do
    it 'should create an instance of CalculateLetterPriceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateLetterPriceRequest)
    end
  end
