...
# Unit tests for ClickSend::CalculateLetterPrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateLetterPrice do
  #let(:instance) { ClickSend::CalculateLetterPrice.new }

  describe 'test an instance of CalculateLetterPrice' do
    it 'should create an instance of CalculateLetterPrice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateLetterPrice)
    end
  end
