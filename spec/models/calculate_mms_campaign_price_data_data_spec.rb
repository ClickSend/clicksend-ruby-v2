...
# Unit tests for ClickSend::CalculateMmsCampaignPriceDataData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateMmsCampaignPriceDataData do
  #let(:instance) { ClickSend::CalculateMmsCampaignPriceDataData.new }

  describe 'test an instance of CalculateMmsCampaignPriceDataData' do
    it 'should create an instance of CalculateMmsCampaignPriceDataData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateMmsCampaignPriceDataData)
    end
  end
