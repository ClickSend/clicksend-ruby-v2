...
# Unit tests for ClickSend::CalculateMmsCampaignPriceData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateMmsCampaignPriceData do
  #let(:instance) { ClickSend::CalculateMmsCampaignPriceData.new }

  describe 'test an instance of CalculateMmsCampaignPriceData' do
    it 'should create an instance of CalculateMmsCampaignPriceData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateMmsCampaignPriceData)
    end
  end
