...
# Unit tests for ClickSend::CalculateMmsCampaignPrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateMmsCampaignPrice do
  #let(:instance) { ClickSend::CalculateMmsCampaignPrice.new }

  describe 'test an instance of CalculateMmsCampaignPrice' do
    it 'should create an instance of CalculateMmsCampaignPrice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateMmsCampaignPrice)
    end
  end
