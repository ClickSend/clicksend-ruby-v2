...
# Unit tests for ClickSend::CalculateMmsPriceRequestMessagesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateMmsPriceRequestMessagesInner do
  #let(:instance) { ClickSend::CalculateMmsPriceRequestMessagesInner.new }

  describe 'test an instance of CalculateMmsPriceRequestMessagesInner' do
    it 'should create an instance of CalculateMmsPriceRequestMessagesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateMmsPriceRequestMessagesInner)
    end
  end
