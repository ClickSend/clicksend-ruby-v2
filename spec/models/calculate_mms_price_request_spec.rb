...
# Unit tests for ClickSend::CalculateMmsPriceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateMmsPriceRequest do
  #let(:instance) { ClickSend::CalculateMmsPriceRequest.new }

  describe 'test an instance of CalculateMmsPriceRequest' do
    it 'should create an instance of CalculateMmsPriceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateMmsPriceRequest)
    end
  end
