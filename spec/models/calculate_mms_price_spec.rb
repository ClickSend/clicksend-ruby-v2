...
# Unit tests for ClickSend::CalculateMmsPrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateMmsPrice do
  #let(:instance) { ClickSend::CalculateMmsPrice.new }

  describe 'test an instance of CalculateMmsPrice' do
    it 'should create an instance of CalculateMmsPrice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateMmsPrice)
    end
  end
