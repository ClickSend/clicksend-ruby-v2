...
# Unit tests for ClickSend::CalculatePostcardPrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculatePostcardPrice do
  #let(:instance) { ClickSend::CalculatePostcardPrice.new }

  describe 'test an instance of CalculatePostcardPrice' do
    it 'should create an instance of CalculatePostcardPrice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculatePostcardPrice)
    end
  end
