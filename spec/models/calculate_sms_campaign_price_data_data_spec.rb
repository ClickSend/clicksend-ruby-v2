...
# Unit tests for ClickSend::CalculateSmsCampaignPriceDataData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateSmsCampaignPriceDataData do
  #let(:instance) { ClickSend::CalculateSmsCampaignPriceDataData.new }

  describe 'test an instance of CalculateSmsCampaignPriceDataData' do
    it 'should create an instance of CalculateSmsCampaignPriceDataData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateSmsCampaignPriceDataData)
    end
  end
