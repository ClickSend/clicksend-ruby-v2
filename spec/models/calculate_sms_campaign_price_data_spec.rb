...
# Unit tests for ClickSend::CalculateSmsCampaignPriceData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateSmsCampaignPriceData do
  #let(:instance) { ClickSend::CalculateSmsCampaignPriceData.new }

  describe 'test an instance of CalculateSmsCampaignPriceData' do
    it 'should create an instance of CalculateSmsCampaignPriceData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateSmsCampaignPriceData)
    end
  end
