...
# Unit tests for ClickSend::CalculateSmsCampaignPriceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateSmsCampaignPriceRequest do
  #let(:instance) { ClickSend::CalculateSmsCampaignPriceRequest.new }

  describe 'test an instance of CalculateSmsCampaignPriceRequest' do
    it 'should create an instance of CalculateSmsCampaignPriceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateSmsCampaignPriceRequest)
    end
  end
