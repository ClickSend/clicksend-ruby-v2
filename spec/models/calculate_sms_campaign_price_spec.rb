...
# Unit tests for ClickSend::CalculateSmsCampaignPrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateSmsCampaignPrice do
  #let(:instance) { ClickSend::CalculateSmsCampaignPrice.new }

  describe 'test an instance of CalculateSmsCampaignPrice' do
    it 'should create an instance of CalculateSmsCampaignPrice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateSmsCampaignPrice)
    end
  end
