...
# Unit tests for ClickSend::CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt do
  #let(:instance) { ClickSend::CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt.new }

  describe 'test an instance of CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt' do
    it 'should create an instance of CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateSmsPriceDataSummaryCountriesInnerCountryRegulationCreatedAt)
    end
  end
