...
# Unit tests for ClickSend::CalculateSmsPriceDataSummaryCountriesInnerCountryRegulation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateSmsPriceDataSummaryCountriesInnerCountryRegulation do
  #let(:instance) { ClickSend::CalculateSmsPriceDataSummaryCountriesInnerCountryRegulation.new }

  describe 'test an instance of CalculateSmsPriceDataSummaryCountriesInnerCountryRegulation' do
    it 'should create an instance of CalculateSmsPriceDataSummaryCountriesInnerCountryRegulation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateSmsPriceDataSummaryCountriesInnerCountryRegulation)
    end
  end

  describe 'test attribute "country_user_id"' do
    it 'should work' do
