...
# Unit tests for ClickSend::CalculateSmsPriceDataSummaryCountriesInnerCountry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateSmsPriceDataSummaryCountriesInnerCountry do
  #let(:instance) { ClickSend::CalculateSmsPriceDataSummaryCountriesInnerCountry.new }

  describe 'test an instance of CalculateSmsPriceDataSummaryCountriesInnerCountry' do
    it 'should create an instance of CalculateSmsPriceDataSummaryCountriesInnerCountry' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateSmsPriceDataSummaryCountriesInnerCountry)
    end
  end
  ...
  describe 'test attribute "receipient_count"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "usable_sender_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "regulation"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "registration_status_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "registration_entity_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
