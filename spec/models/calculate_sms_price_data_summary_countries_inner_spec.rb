...
# Unit tests for ClickSend::CalculateSmsPriceDataSummaryCountriesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateSmsPriceDataSummaryCountriesInner do
  #let(:instance) { ClickSend::CalculateSmsPriceDataSummaryCountriesInner.new }

  describe 'test an instance of CalculateSmsPriceDataSummaryCountriesInner' do
    it 'should create an instance of CalculateSmsPriceDataSummaryCountriesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateSmsPriceDataSummaryCountriesInner)
    end
  end
