...
# Unit tests for ClickSend::CalculateSmsPriceDataSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateSmsPriceDataSummary do
  #let(:instance) { ClickSend::CalculateSmsPriceDataSummary.new }

  describe 'test an instance of CalculateSmsPriceDataSummary' do
    it 'should create an instance of CalculateSmsPriceDataSummary' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateSmsPriceDataSummary)
    end
  end

  describe 'test attribute "test_message"' do
    it 'should work' do
