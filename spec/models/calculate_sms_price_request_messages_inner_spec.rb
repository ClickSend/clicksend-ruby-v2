...
# Unit tests for ClickSend::CalculateSmsPriceRequestMessagesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateSmsPriceRequestMessagesInner do
  #let(:instance) { ClickSend::CalculateSmsPriceRequestMessagesInner.new }

  describe 'test an instance of CalculateSmsPriceRequestMessagesInner' do
    it 'should create an instance of CalculateSmsPriceRequestMessagesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateSmsPriceRequestMessagesInner)
    end
  end
  ...
  describe 'test attribute "show_summary"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
