...
# Unit tests for ClickSend::CalculateSmsPriceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateSmsPriceRequest do
  #let(:instance) { ClickSend::CalculateSmsPriceRequest.new }

  describe 'test an instance of CalculateSmsPriceRequest' do
    it 'should create an instance of CalculateSmsPriceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateSmsPriceRequest)
    end
  end
  ...
  describe 'test attribute "shorten_urls"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
