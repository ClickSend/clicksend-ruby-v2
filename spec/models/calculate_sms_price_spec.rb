...
# Unit tests for ClickSend::CalculateSmsPrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateSmsPrice do
  #let(:instance) { ClickSend::CalculateSmsPrice.new }

  describe 'test an instance of CalculateSmsPrice' do
    it 'should create an instance of CalculateSmsPrice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateSmsPrice)
    end
  end
