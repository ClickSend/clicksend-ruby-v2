...
# Unit tests for ClickSend::CalculateVoicePriceRequestMessagesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateVoicePriceRequestMessagesInner do
  #let(:instance) { ClickSend::CalculateVoicePriceRequestMessagesInner.new }

  describe 'test an instance of CalculateVoicePriceRequestMessagesInner' do
    it 'should create an instance of CalculateVoicePriceRequestMessagesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateVoicePriceRequestMessagesInner)
    end
  end
  ...
  describe 'test attribute "asdasd"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
