...
# Unit tests for ClickSend::CalculateVoicePriceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateVoicePriceRequest do
  #let(:instance) { ClickSend::CalculateVoicePriceRequest.new }

  describe 'test an instance of CalculateVoicePriceRequest' do
    it 'should create an instance of CalculateVoicePriceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateVoicePriceRequest)
    end
  end
