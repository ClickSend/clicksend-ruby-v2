...
# Unit tests for ClickSend::CalculateVoicePrice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CalculateVoicePrice do
  #let(:instance) { ClickSend::CalculateVoicePrice.new }

  describe 'test an instance of CalculateVoicePrice' do
    it 'should create an instance of CalculateVoicePrice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CalculateVoicePrice)
    end
  end
