...
# Unit tests for ClickSend::CancelAllSmsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CancelAllSmsData do
  #let(:instance) { ClickSend::CancelAllSmsData.new }

  describe 'test an instance of CancelAllSmsData' do
    it 'should create an instance of CancelAllSmsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CancelAllSmsData)
    end
  end
