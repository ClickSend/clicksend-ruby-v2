...
# Unit tests for ClickSend::CancelAllSmsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CancelAllSmsRequest do
  #let(:instance) { ClickSend::CancelAllSmsRequest.new }

  describe 'test an instance of CancelAllSmsRequest' do
    it 'should create an instance of CancelAllSmsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CancelAllSmsRequest)
    end
  end
