...
# Unit tests for ClickSend::CancelAllSms
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CancelAllSms do
  #let(:instance) { ClickSend::CancelAllSms.new }

  describe 'test an instance of CancelAllSms' do
    it 'should create an instance of CancelAllSms' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CancelAllSms)
    end
  end
