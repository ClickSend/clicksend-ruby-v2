...
# Unit tests for ClickSend::CancelAllVoiceMessages
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CancelAllVoiceMessages do
  #let(:instance) { ClickSend::CancelAllVoiceMessages.new }

  describe 'test an instance of CancelAllVoiceMessages' do
    it 'should create an instance of CancelAllVoiceMessages' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CancelAllVoiceMessages)
    end
  end
