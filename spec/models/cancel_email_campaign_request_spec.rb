...
# Unit tests for ClickSend::CancelEmailCampaignRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CancelEmailCampaignRequest do
  #let(:instance) { ClickSend::CancelEmailCampaignRequest.new }

  describe 'test an instance of CancelEmailCampaignRequest' do
    it 'should create an instance of CancelEmailCampaignRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CancelEmailCampaignRequest)
    end
  end
