...
# Unit tests for ClickSend::CancelEmailCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CancelEmailCampaign do
  #let(:instance) { ClickSend::CancelEmailCampaign.new }

  describe 'test an instance of CancelEmailCampaign' do
    it 'should create an instance of CancelEmailCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CancelEmailCampaign)
    end
  end
