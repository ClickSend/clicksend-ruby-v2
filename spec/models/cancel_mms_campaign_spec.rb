...
# Unit tests for ClickSend::CancelMmsCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CancelMmsCampaign do
  #let(:instance) { ClickSend::CancelMmsCampaign.new }

  describe 'test an instance of CancelMmsCampaign' do
    it 'should create an instance of CancelMmsCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CancelMmsCampaign)
    end
  end
