...
# Unit tests for ClickSend::CancelScheduledLetter
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CancelScheduledLetter do
  #let(:instance) { ClickSend::CancelScheduledLetter.new }

  describe 'test an instance of CancelScheduledLetter' do
    it 'should create an instance of CancelScheduledLetter' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CancelScheduledLetter)
    end
  end
