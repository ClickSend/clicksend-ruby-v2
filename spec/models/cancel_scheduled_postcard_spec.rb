...
# Unit tests for ClickSend::CancelScheduledPostcard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CancelScheduledPostcard do
  #let(:instance) { ClickSend::CancelScheduledPostcard.new }

  describe 'test an instance of CancelScheduledPostcard' do
    it 'should create an instance of CancelScheduledPostcard' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CancelScheduledPostcard)
    end
  end
