...
# Unit tests for ClickSend::CancelSmsCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CancelSmsCampaign do
  #let(:instance) { ClickSend::CancelSmsCampaign.new }

  describe 'test an instance of CancelSmsCampaign' do
    it 'should create an instance of CancelSmsCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CancelSmsCampaign)
    end
  end
