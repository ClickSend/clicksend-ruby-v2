...
# Unit tests for ClickSend::CancelSms
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CancelSms do
  #let(:instance) { ClickSend::CancelSms.new }

  describe 'test an instance of CancelSms' do
    it 'should create an instance of CancelSms' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CancelSms)
    end
  end
