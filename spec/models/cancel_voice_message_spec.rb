...
# Unit tests for ClickSend::CancelVoiceMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CancelVoiceMessage do
  #let(:instance) { ClickSend::CancelVoiceMessage.new }

  describe 'test an instance of CancelVoiceMessage' do
    it 'should create an instance of CancelVoiceMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CancelVoiceMessage)
    end
  end
