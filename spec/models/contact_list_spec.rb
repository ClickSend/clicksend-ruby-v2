...
# Unit tests for ClickSend::ContactList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ContactList do
  #let(:instance) { ClickSend::ContactList.new }

  describe 'test an instance of ContactList' do
    it 'should create an instance of ContactList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ContactList)
    end
  end
  ...
  describe 'test attribute "list_email_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "_contacts_count"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
