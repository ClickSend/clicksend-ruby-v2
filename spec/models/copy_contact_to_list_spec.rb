...
# Unit tests for ClickSend::CopyContactToList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CopyContactToList do
  #let(:instance) { ClickSend::CopyContactToList.new }

  describe 'test an instance of CopyContactToList' do
    it 'should create an instance of CopyContactToList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CopyContactToList)
    end
  end
