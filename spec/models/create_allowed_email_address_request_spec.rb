...
# Unit tests for ClickSend::CreateAllowedEmailAddressRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateAllowedEmailAddressRequest do
  #let(:instance) { ClickSend::CreateAllowedEmailAddressRequest.new }

  describe 'test an instance of CreateAllowedEmailAddressRequest' do
    it 'should create an instance of CreateAllowedEmailAddressRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateAllowedEmailAddressRequest)
    end
  end
