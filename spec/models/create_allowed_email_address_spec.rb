...
# Unit tests for ClickSend::CreateAllowedEmailAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateAllowedEmailAddress do
  #let(:instance) { ClickSend::CreateAllowedEmailAddress.new }

  describe 'test an instance of CreateAllowedEmailAddress' do
    it 'should create an instance of CreateAllowedEmailAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateAllowedEmailAddress)
    end
  end
