...
# Unit tests for ClickSend::CreateDefaultSenderRequestDefaultSenderStrategiesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateDefaultSenderRequestDefaultSenderStrategiesInner do
  #let(:instance) { ClickSend::CreateDefaultSenderRequestDefaultSenderStrategiesInner.new }

  describe 'test an instance of CreateDefaultSenderRequestDefaultSenderStrategiesInner' do
    it 'should create an instance of CreateDefaultSenderRequestDefaultSenderStrategiesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateDefaultSenderRequestDefaultSenderStrategiesInner)
    end
  end
