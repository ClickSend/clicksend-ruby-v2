...
# Unit tests for ClickSend::CreateDefaultSenderRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateDefaultSenderRequest do
  #let(:instance) { ClickSend::CreateDefaultSenderRequest.new }

  describe 'test an instance of CreateDefaultSenderRequest' do
    it 'should create an instance of CreateDefaultSenderRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateDefaultSenderRequest)
    end
  end
  ...
  describe 'test attribute "default_sender_strategies"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
