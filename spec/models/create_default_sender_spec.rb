...
# Unit tests for ClickSend::CreateDefaultSender
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateDefaultSender do
  #let(:instance) { ClickSend::CreateDefaultSender.new }

  describe 'test an instance of CreateDefaultSender' do
    it 'should create an instance of CreateDefaultSender' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateDefaultSender)
    end
  end
