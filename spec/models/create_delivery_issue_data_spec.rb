...
# Unit tests for ClickSend::CreateDeliveryIssueData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateDeliveryIssueData do
  #let(:instance) { ClickSend::CreateDeliveryIssueData.new }

  describe 'test an instance of CreateDeliveryIssueData' do
    it 'should create an instance of CreateDeliveryIssueData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateDeliveryIssueData)
    end
  end
