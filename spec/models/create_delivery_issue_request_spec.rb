...
# Unit tests for ClickSend::CreateDeliveryIssueRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateDeliveryIssueRequest do
  #let(:instance) { ClickSend::CreateDeliveryIssueRequest.new }

  describe 'test an instance of CreateDeliveryIssueRequest' do
    it 'should create an instance of CreateDeliveryIssueRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateDeliveryIssueRequest)
    end
  end
  ...
  describe 'test attribute "support_comments"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
