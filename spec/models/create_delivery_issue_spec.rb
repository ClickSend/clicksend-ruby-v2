...
# Unit tests for ClickSend::CreateDeliveryIssue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateDeliveryIssue do
  #let(:instance) { ClickSend::CreateDeliveryIssue.new }

  describe 'test an instance of CreateDeliveryIssue' do
    it 'should create an instance of CreateDeliveryIssue' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateDeliveryIssue)
    end
  end
