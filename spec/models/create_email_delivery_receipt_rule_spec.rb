...
# Unit tests for ClickSend::CreateEmailDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateEmailDeliveryReceiptRule do
  #let(:instance) { ClickSend::CreateEmailDeliveryReceiptRule.new }

  describe 'test an instance of CreateEmailDeliveryReceiptRule' do
    it 'should create an instance of CreateEmailDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateEmailDeliveryReceiptRule)
    end
  end
