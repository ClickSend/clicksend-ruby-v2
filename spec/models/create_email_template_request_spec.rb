...
# Unit tests for ClickSend::CreateEmailTemplateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateEmailTemplateRequest do
  #let(:instance) { ClickSend::CreateEmailTemplateRequest.new }

  describe 'test an instance of CreateEmailTemplateRequest' do
    it 'should create an instance of CreateEmailTemplateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateEmailTemplateRequest)
    end
  end
