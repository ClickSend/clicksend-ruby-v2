...
# Unit tests for ClickSend::CreateEmailTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateEmailTemplate do
  #let(:instance) { ClickSend::CreateEmailTemplate.new }

  describe 'test an instance of CreateEmailTemplate' do
    it 'should create an instance of CreateEmailTemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateEmailTemplate)
    end
  end
