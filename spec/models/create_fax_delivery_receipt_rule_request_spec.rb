...
# Unit tests for ClickSend::CreateFaxDeliveryReceiptRuleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateFaxDeliveryReceiptRuleRequest do
  #let(:instance) { ClickSend::CreateFaxDeliveryReceiptRuleRequest.new }

  describe 'test an instance of CreateFaxDeliveryReceiptRuleRequest' do
    it 'should create an instance of CreateFaxDeliveryReceiptRuleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateFaxDeliveryReceiptRuleRequest)
    end
  end
