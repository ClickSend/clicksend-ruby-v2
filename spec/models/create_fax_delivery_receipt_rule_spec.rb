...
# Unit tests for ClickSend::CreateFaxDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateFaxDeliveryReceiptRule do
  #let(:instance) { ClickSend::CreateFaxDeliveryReceiptRule.new }

  describe 'test an instance of CreateFaxDeliveryReceiptRule' do
    it 'should create an instance of CreateFaxDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateFaxDeliveryReceiptRule)
    end
  end
