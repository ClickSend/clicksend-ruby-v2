...
# Unit tests for ClickSend::CreateFaxInboundRuleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateFaxInboundRuleRequest do
  #let(:instance) { ClickSend::CreateFaxInboundRuleRequest.new }

  describe 'test an instance of CreateFaxInboundRuleRequest' do
    it 'should create an instance of CreateFaxInboundRuleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateFaxInboundRuleRequest)
    end
  end
