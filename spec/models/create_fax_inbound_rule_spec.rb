...
# Unit tests for ClickSend::CreateFaxInboundRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateFaxInboundRule do
  #let(:instance) { ClickSend::CreateFaxInboundRule.new }

  describe 'test an instance of CreateFaxInboundRule' do
    it 'should create an instance of CreateFaxInboundRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateFaxInboundRule)
    end
  end
