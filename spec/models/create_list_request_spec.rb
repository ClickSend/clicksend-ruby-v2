...
# Unit tests for ClickSend::CreateListRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateListRequest do
  #let(:instance) { ClickSend::CreateListRequest.new }

  describe 'test an instance of CreateListRequest' do
    it 'should create an instance of CreateListRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateListRequest)
    end
  end
