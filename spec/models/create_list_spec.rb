...
# Unit tests for ClickSend::CreateList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateList do
  #let(:instance) { ClickSend::CreateList.new }

  describe 'test an instance of CreateList' do
    it 'should create an instance of CreateList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateList)
    end
  end
