...
# Unit tests for ClickSend::CreateNewContactRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateNewContactRequest do
  #let(:instance) { ClickSend::CreateNewContactRequest.new }

  describe 'test an instance of CreateNewContactRequest' do
    it 'should create an instance of CreateNewContactRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateNewContactRequest)
    end
  end
