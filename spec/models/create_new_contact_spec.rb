...
# Unit tests for ClickSend::CreateNewContact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateNewContact do
  #let(:instance) { ClickSend::CreateNewContact.new }

  describe 'test an instance of CreateNewContact' do
    it 'should create an instance of CreateNewContact' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateNewContact)
    end
  end
