...
# Unit tests for ClickSend::CreateResellerAccountData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateResellerAccountData do
  #let(:instance) { ClickSend::CreateResellerAccountData.new }

  describe 'test an instance of CreateResellerAccountData' do
    it 'should create an instance of CreateResellerAccountData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateResellerAccountData)
    end
  end
