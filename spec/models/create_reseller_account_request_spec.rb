...
# Unit tests for ClickSend::CreateResellerAccountRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateResellerAccountRequest do
  #let(:instance) { ClickSend::CreateResellerAccountRequest.new }

  describe 'test an instance of CreateResellerAccountRequest' do
    it 'should create an instance of CreateResellerAccountRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateResellerAccountRequest)
    end
  end
