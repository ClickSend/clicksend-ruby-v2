...
# Unit tests for ClickSend::CreateResellerAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateResellerAccount do
  #let(:instance) { ClickSend::CreateResellerAccount.new }

  describe 'test an instance of CreateResellerAccount' do
    it 'should create an instance of CreateResellerAccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateResellerAccount)
    end
  end
