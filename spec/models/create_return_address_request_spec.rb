...
# Unit tests for ClickSend::CreateReturnAddressRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateReturnAddressRequest do
  #let(:instance) { ClickSend::CreateReturnAddressRequest.new }

  describe 'test an instance of CreateReturnAddressRequest' do
    it 'should create an instance of CreateReturnAddressRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateReturnAddressRequest)
    end
  end
