...
# Unit tests for ClickSend::CreateReturnAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateReturnAddress do
  #let(:instance) { ClickSend::CreateReturnAddress.new }

  describe 'test an instance of CreateReturnAddress' do
    it 'should create an instance of CreateReturnAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateReturnAddress)
    end
  end
