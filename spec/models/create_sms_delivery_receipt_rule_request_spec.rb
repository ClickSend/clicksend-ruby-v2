...
# Unit tests for ClickSend::CreateSmsDeliveryReceiptRuleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateSmsDeliveryReceiptRuleRequest do
  #let(:instance) { ClickSend::CreateSmsDeliveryReceiptRuleRequest.new }

  describe 'test an instance of CreateSmsDeliveryReceiptRuleRequest' do
    it 'should create an instance of CreateSmsDeliveryReceiptRuleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateSmsDeliveryReceiptRuleRequest)
    end
  end
