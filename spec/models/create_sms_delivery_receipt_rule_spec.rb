...
# Unit tests for ClickSend::CreateSmsDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateSmsDeliveryReceiptRule do
  #let(:instance) { ClickSend::CreateSmsDeliveryReceiptRule.new }

  describe 'test an instance of CreateSmsDeliveryReceiptRule' do
    it 'should create an instance of CreateSmsDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateSmsDeliveryReceiptRule)
    end
  end
