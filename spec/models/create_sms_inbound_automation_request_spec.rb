...
# Unit tests for ClickSend::CreateSmsInboundAutomationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateSmsInboundAutomationRequest do
  #let(:instance) { ClickSend::CreateSmsInboundAutomationRequest.new }

  describe 'test an instance of CreateSmsInboundAutomationRequest' do
    it 'should create an instance of CreateSmsInboundAutomationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateSmsInboundAutomationRequest)
    end
  end
