...
# Unit tests for ClickSend::CreateSmsInboundAutomation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateSmsInboundAutomation do
  #let(:instance) { ClickSend::CreateSmsInboundAutomation.new }

  describe 'test an instance of CreateSmsInboundAutomation' do
    it 'should create an instance of CreateSmsInboundAutomation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateSmsInboundAutomation)
    end
  end
