...
# Unit tests for ClickSend::CreateSmsTemplateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateSmsTemplateRequest do
  #let(:instance) { ClickSend::CreateSmsTemplateRequest.new }

  describe 'test an instance of CreateSmsTemplateRequest' do
    it 'should create an instance of CreateSmsTemplateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateSmsTemplateRequest)
    end
  end
