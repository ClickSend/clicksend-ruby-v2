...
# Unit tests for ClickSend::CreateSmsTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateSmsTemplate do
  #let(:instance) { ClickSend::CreateSmsTemplate.new }

  describe 'test an instance of CreateSmsTemplate' do
    it 'should create an instance of CreateSmsTemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateSmsTemplate)
    end
  end
