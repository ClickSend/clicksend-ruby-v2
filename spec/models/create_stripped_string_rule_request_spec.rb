...
# Unit tests for ClickSend::CreateStrippedStringRuleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateStrippedStringRuleRequest do
  #let(:instance) { ClickSend::CreateStrippedStringRuleRequest.new }

  describe 'test an instance of CreateStrippedStringRuleRequest' do
    it 'should create an instance of CreateStrippedStringRuleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateStrippedStringRuleRequest)
    end
  end
