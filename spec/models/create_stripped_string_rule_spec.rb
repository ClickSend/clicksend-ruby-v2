...
# Unit tests for ClickSend::CreateStrippedStringRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateStrippedStringRule do
  #let(:instance) { ClickSend::CreateStrippedStringRule.new }

  describe 'test an instance of CreateStrippedStringRule' do
    it 'should create an instance of CreateStrippedStringRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateStrippedStringRule)
    end
  end
