...
# Unit tests for ClickSend::CreateSubaccountRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateSubaccountRequest do
  #let(:instance) { ClickSend::CreateSubaccountRequest.new }
  ...
  describe 'test an instance of CreateSubaccountRequest' do
    it 'should create an instance of CreateSubaccountRequest' do
      ...
      #expect(instance).to be_instance_of(ClickSend::CreateSubaccountRequest)
    end
  end
  ...
  describe 'test attribute "sms_deidentify_message"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
