...
# Unit tests for ClickSend::CreateSubaccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateSubaccount do
  #let(:instance) { ClickSend::CreateSubaccount.new }

  describe 'test an instance of CreateSubaccount' do
    it 'should create an instance of CreateSubaccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateSubaccount)
    end
  end
