...
# Unit tests for ClickSend::CreateTestInboundSmsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateTestInboundSmsRequest do
  #let(:instance) { ClickSend::CreateTestInboundSmsRequest.new }

  describe 'test an instance of CreateTestInboundSmsRequest' do
    it 'should create an instance of CreateTestInboundSmsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateTestInboundSmsRequest)
    end
  end
