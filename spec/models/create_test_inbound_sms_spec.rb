...
# Unit tests for ClickSend::CreateTestInboundSms
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateTestInboundSms do
  #let(:instance) { ClickSend::CreateTestInboundSms.new }

  describe 'test an instance of CreateTestInboundSms' do
    it 'should create an instance of CreateTestInboundSms' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateTestInboundSms)
    end
  end
