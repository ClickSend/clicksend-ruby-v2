...
# Unit tests for ClickSend::CreateTestSmsReceiptData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateTestSmsReceiptData do
  #let(:instance) { ClickSend::CreateTestSmsReceiptData.new }

  describe 'test an instance of CreateTestSmsReceiptData' do
    it 'should create an instance of CreateTestSmsReceiptData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateTestSmsReceiptData)
    end
  end
