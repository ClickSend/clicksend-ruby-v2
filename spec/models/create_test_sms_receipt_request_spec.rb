...
# Unit tests for ClickSend::CreateTestSmsReceiptRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateTestSmsReceiptRequest do
  #let(:instance) { ClickSend::CreateTestSmsReceiptRequest.new }

  describe 'test an instance of CreateTestSmsReceiptRequest' do
    it 'should create an instance of CreateTestSmsReceiptRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateTestSmsReceiptRequest)
    end
  end
