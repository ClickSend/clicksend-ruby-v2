...
# Unit tests for ClickSend::CreateTestSmsReceipt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateTestSmsReceipt do
  #let(:instance) { ClickSend::CreateTestSmsReceipt.new }

  describe 'test an instance of CreateTestSmsReceipt' do
    it 'should create an instance of CreateTestSmsReceipt' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateTestSmsReceipt)
    end
  end
