...
# Unit tests for ClickSend::CreateVoiceDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CreateVoiceDeliveryReceiptRule do
  #let(:instance) { ClickSend::CreateVoiceDeliveryReceiptRule.new }

  describe 'test an instance of CreateVoiceDeliveryReceiptRule' do
    it 'should create an instance of CreateVoiceDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CreateVoiceDeliveryReceiptRule)
    end
  end
