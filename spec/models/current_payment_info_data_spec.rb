...
# Unit tests for ClickSend::CurrentPaymentInfoData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CurrentPaymentInfoData do
  #let(:instance) { ClickSend::CurrentPaymentInfoData.new }

  describe 'test an instance of CurrentPaymentInfoData' do
    it 'should create an instance of CurrentPaymentInfoData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CurrentPaymentInfoData)
    end
  end

  describe 'test attribute "display_number"' do
    it 'should work' do
