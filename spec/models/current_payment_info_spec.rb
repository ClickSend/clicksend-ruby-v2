...
# Unit tests for ClickSend::CurrentPaymentInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::CurrentPaymentInfo do
  #let(:instance) { ClickSend::CurrentPaymentInfo.new }

  describe 'test an instance of CurrentPaymentInfo' do
    it 'should create an instance of CurrentPaymentInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::CurrentPaymentInfo)
    end
  end
