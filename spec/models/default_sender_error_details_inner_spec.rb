...
# Unit tests for ClickSend::DefaultSenderErrorDetailsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DefaultSenderErrorDetailsInner do
  #let(:instance) { ClickSend::DefaultSenderErrorDetailsInner.new }

  describe 'test an instance of DefaultSenderErrorDetailsInner' do
    it 'should create an instance of DefaultSenderErrorDetailsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DefaultSenderErrorDetailsInner)
    end
  end
