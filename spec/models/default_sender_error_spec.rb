...
# Unit tests for ClickSend::DefaultSenderError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DefaultSenderError do
  #let(:instance) { ClickSend::DefaultSenderError.new }

  describe 'test an instance of DefaultSenderError' do
    it 'should create an instance of DefaultSenderError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DefaultSenderError)
    end
  end
