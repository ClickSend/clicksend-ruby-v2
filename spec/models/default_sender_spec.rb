...
# Unit tests for ClickSend::DefaultSender
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DefaultSender do
  #let(:instance) { ClickSend::DefaultSender.new }

  describe 'test an instance of DefaultSender' do
    it 'should create an instance of DefaultSender' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DefaultSender)
    end
  end
