...
# Unit tests for ClickSend::DeleteAllowedEmailAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeleteAllowedEmailAddress do
  #let(:instance) { ClickSend::DeleteAllowedEmailAddress.new }

  describe 'test an instance of DeleteAllowedEmailAddress' do
    it 'should create an instance of DeleteAllowedEmailAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeleteAllowedEmailAddress)
    end
  end
