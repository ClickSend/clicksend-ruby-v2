...
# Unit tests for ClickSend::DeleteContact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeleteContact do
  #let(:instance) { ClickSend::DeleteContact.new }

  describe 'test an instance of DeleteContact' do
    it 'should create an instance of DeleteContact' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeleteContact)
    end
  end
