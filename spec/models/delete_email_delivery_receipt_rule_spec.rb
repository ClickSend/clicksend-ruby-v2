...
# Unit tests for ClickSend::DeleteEmailDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeleteEmailDeliveryReceiptRule do
  #let(:instance) { ClickSend::DeleteEmailDeliveryReceiptRule.new }

  describe 'test an instance of DeleteEmailDeliveryReceiptRule' do
    it 'should create an instance of DeleteEmailDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeleteEmailDeliveryReceiptRule)
    end
  end
