...
# Unit tests for ClickSend::DeleteEmailTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeleteEmailTemplate do
  #let(:instance) { ClickSend::DeleteEmailTemplate.new }

  describe 'test an instance of DeleteEmailTemplate' do
    it 'should create an instance of DeleteEmailTemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeleteEmailTemplate)
    end
  end
