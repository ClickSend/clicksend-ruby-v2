...
# Unit tests for ClickSend::DeleteFaxDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeleteFaxDeliveryReceiptRule do
  #let(:instance) { ClickSend::DeleteFaxDeliveryReceiptRule.new }

  describe 'test an instance of DeleteFaxDeliveryReceiptRule' do
    it 'should create an instance of DeleteFaxDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeleteFaxDeliveryReceiptRule)
    end
  end
