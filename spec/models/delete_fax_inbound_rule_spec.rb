...
# Unit tests for ClickSend::DeleteFaxInboundRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeleteFaxInboundRule do
  #let(:instance) { ClickSend::DeleteFaxInboundRule.new }

  describe 'test an instance of DeleteFaxInboundRule' do
    it 'should create an instance of DeleteFaxInboundRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeleteFaxInboundRule)
    end
  end
