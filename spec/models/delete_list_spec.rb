...
# Unit tests for ClickSend::DeleteList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeleteList do
  #let(:instance) { ClickSend::DeleteList.new }

  describe 'test an instance of DeleteList' do
    it 'should create an instance of DeleteList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeleteList)
    end
  end
