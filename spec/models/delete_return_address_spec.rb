...
# Unit tests for ClickSend::DeleteReturnAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeleteReturnAddress do
  #let(:instance) { ClickSend::DeleteReturnAddress.new }

  describe 'test an instance of DeleteReturnAddress' do
    it 'should create an instance of DeleteReturnAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeleteReturnAddress)
    end
  end
