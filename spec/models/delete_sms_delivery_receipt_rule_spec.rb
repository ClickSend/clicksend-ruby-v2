...
# Unit tests for ClickSend::DeleteSmsDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeleteSmsDeliveryReceiptRule do
  #let(:instance) { ClickSend::DeleteSmsDeliveryReceiptRule.new }

  describe 'test an instance of DeleteSmsDeliveryReceiptRule' do
    it 'should create an instance of DeleteSmsDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeleteSmsDeliveryReceiptRule)
    end
  end
