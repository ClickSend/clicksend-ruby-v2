...
# Unit tests for ClickSend::DeleteSmsInboundAutomation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeleteSmsInboundAutomation do
  #let(:instance) { ClickSend::DeleteSmsInboundAutomation.new }

  describe 'test an instance of DeleteSmsInboundAutomation' do
    it 'should create an instance of DeleteSmsInboundAutomation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeleteSmsInboundAutomation)
    end
  end
