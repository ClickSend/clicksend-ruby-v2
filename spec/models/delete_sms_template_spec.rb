...
# Unit tests for ClickSend::DeleteSmsTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeleteSmsTemplate do
  #let(:instance) { ClickSend::DeleteSmsTemplate.new }

  describe 'test an instance of DeleteSmsTemplate' do
    it 'should create an instance of DeleteSmsTemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeleteSmsTemplate)
    end
  end
