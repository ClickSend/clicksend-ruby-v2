...
# Unit tests for ClickSend::DeleteStrippedStringRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeleteStrippedStringRule do
  #let(:instance) { ClickSend::DeleteStrippedStringRule.new }

  describe 'test an instance of DeleteStrippedStringRule' do
    it 'should create an instance of DeleteStrippedStringRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeleteStrippedStringRule)
    end
  end
