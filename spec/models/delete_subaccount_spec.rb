...
# Unit tests for ClickSend::DeleteSubaccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeleteSubaccount do
  #let(:instance) { ClickSend::DeleteSubaccount.new }

  describe 'test an instance of DeleteSubaccount' do
    it 'should create an instance of DeleteSubaccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeleteSubaccount)
    end
  end
