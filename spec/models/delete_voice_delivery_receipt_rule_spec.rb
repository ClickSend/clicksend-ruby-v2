...
# Unit tests for ClickSend::DeleteVoiceDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeleteVoiceDeliveryReceiptRule do
  #let(:instance) { ClickSend::DeleteVoiceDeliveryReceiptRule.new }

  describe 'test an instance of DeleteVoiceDeliveryReceiptRule' do
    it 'should create an instance of DeleteVoiceDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeleteVoiceDeliveryReceiptRule)
    end
  end
