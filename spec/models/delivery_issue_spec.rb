...
# Unit tests for ClickSend::DeliveryIssue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DeliveryIssue do
  #let(:instance) { ClickSend::DeliveryIssue.new }

  describe 'test an instance of DeliveryIssue' do
    it 'should create an instance of DeliveryIssue' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DeliveryIssue)
    end
  end
