...
# Unit tests for ClickSend::DetectAddressData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DetectAddressData do
  #let(:instance) { ClickSend::DetectAddressData.new }

  describe 'test an instance of DetectAddressData' do
    it 'should create an instance of DetectAddressData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DetectAddressData)
    end
  end
