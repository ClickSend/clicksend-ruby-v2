...
# Unit tests for ClickSend::DetectAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::DetectAddress do
  #let(:instance) { ClickSend::DetectAddress.new }

  describe 'test an instance of DetectAddress' do
    it 'should create an instance of DetectAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::DetectAddress)
    end
  end
