...
# Unit tests for ClickSend::EmailCampaignHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::EmailCampaignHistory do
  #let(:instance) { ClickSend::EmailCampaignHistory.new }

  describe 'test an instance of EmailCampaignHistory' do
    it 'should create an instance of EmailCampaignHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::EmailCampaignHistory)
    end
  end
