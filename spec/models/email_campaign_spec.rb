...
# Unit tests for ClickSend::EmailCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::EmailCampaign do
  #let(:instance) { ClickSend::EmailCampaign.new }

  describe 'test an instance of EmailCampaign' do
    it 'should create an instance of EmailCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::EmailCampaign)
    end
  end
  ...
  describe 'test attribute "abuse_count"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
