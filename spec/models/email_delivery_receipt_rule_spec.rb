...
# Unit tests for ClickSend::EmailDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::EmailDeliveryReceiptRule do
  #let(:instance) { ClickSend::EmailDeliveryReceiptRule.new }

  describe 'test an instance of EmailDeliveryReceiptRule' do
    it 'should create an instance of EmailDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::EmailDeliveryReceiptRule)
    end
  end

  describe 'test attribute "receipt_rule_id"' do
    it 'should work' do
