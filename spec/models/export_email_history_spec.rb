...
# Unit tests for ClickSend::ExportEmailHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ExportEmailHistory do
  #let(:instance) { ClickSend::ExportEmailHistory.new }

  describe 'test an instance of ExportEmailHistory' do
    it 'should create an instance of ExportEmailHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ExportEmailHistory)
    end
  end
