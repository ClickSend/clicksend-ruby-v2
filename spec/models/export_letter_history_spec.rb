...
# Unit tests for ClickSend::ExportLetterHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ExportLetterHistory do
  #let(:instance) { ClickSend::ExportLetterHistory.new }

  describe 'test an instance of ExportLetterHistory' do
    it 'should create an instance of ExportLetterHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ExportLetterHistory)
    end
  end
