...
# Unit tests for ClickSend::ExportMmsHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ExportMmsHistory do
  #let(:instance) { ClickSend::ExportMmsHistory.new }

  describe 'test an instance of ExportMmsHistory' do
    it 'should create an instance of ExportMmsHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ExportMmsHistory)
    end
  end
