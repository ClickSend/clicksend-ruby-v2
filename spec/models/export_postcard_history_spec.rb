...
# Unit tests for ClickSend::ExportPostcardHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ExportPostcardHistory do
  #let(:instance) { ClickSend::ExportPostcardHistory.new }

  describe 'test an instance of ExportPostcardHistory' do
    it 'should create an instance of ExportPostcardHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ExportPostcardHistory)
    end
  end
