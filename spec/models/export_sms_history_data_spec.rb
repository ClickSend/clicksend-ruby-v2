...
# Unit tests for ClickSend::ExportSmsHistoryData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ExportSmsHistoryData do
  #let(:instance) { ClickSend::ExportSmsHistoryData.new }

  describe 'test an instance of ExportSmsHistoryData' do
    it 'should create an instance of ExportSmsHistoryData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ExportSmsHistoryData)
    end
  end
