...
# Unit tests for ClickSend::ExportSmsHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ExportSmsHistory do
  #let(:instance) { ClickSend::ExportSmsHistory.new }

  describe 'test an instance of ExportSmsHistory' do
    it 'should create an instance of ExportSmsHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ExportSmsHistory)
    end
  end
