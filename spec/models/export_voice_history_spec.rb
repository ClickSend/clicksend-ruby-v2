...
# Unit tests for ClickSend::ExportVoiceHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ExportVoiceHistory do
  #let(:instance) { ClickSend::ExportVoiceHistory.new }

  describe 'test an instance of ExportVoiceHistory' do
    it 'should create an instance of ExportVoiceHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ExportVoiceHistory)
    end
  end
