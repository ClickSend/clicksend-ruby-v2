...
# Unit tests for ClickSend::FaxDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::FaxDeliveryReceiptRule do
  #let(:instance) { ClickSend::FaxDeliveryReceiptRule.new }

  describe 'test an instance of FaxDeliveryReceiptRule' do
    it 'should create an instance of FaxDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::FaxDeliveryReceiptRule)
    end
  end
