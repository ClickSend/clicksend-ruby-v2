...
# Unit tests for ClickSend::FaxReceipt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::FaxReceipt do
  #let(:instance) { ClickSend::FaxReceipt.new }

  describe 'test an instance of FaxReceipt' do
    it 'should create an instance of FaxReceipt' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::FaxReceipt)
    end
  end
