...
# Unit tests for ClickSend::Fax
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::Fax do
  #let(:instance) { ClickSend::Fax.new }

  describe 'test an instance of Fax' do
    it 'should create an instance of Fax' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::Fax)
    end
  end
  ...
  describe 'test attribute "message_pages"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
