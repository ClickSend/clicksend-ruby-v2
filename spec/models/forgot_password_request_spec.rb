...
# Unit tests for ClickSend::ForgotPasswordRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ForgotPasswordRequest do
  #let(:instance) { ClickSend::ForgotPasswordRequest.new }

  describe 'test an instance of ForgotPasswordRequest' do
    it 'should create an instance of ForgotPasswordRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ForgotPasswordRequest)
    end
  end
