...
# Unit tests for ClickSend::ForgotPassword
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ForgotPassword do
  #let(:instance) { ClickSend::ForgotPassword.new }

  describe 'test an instance of ForgotPassword' do
    it 'should create an instance of ForgotPassword' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ForgotPassword)
    end
  end
