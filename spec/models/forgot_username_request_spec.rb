...
# Unit tests for ClickSend::ForgotUsernameRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ForgotUsernameRequest do
  #let(:instance) { ClickSend::ForgotUsernameRequest.new }

  describe 'test an instance of ForgotUsernameRequest' do
    it 'should create an instance of ForgotUsernameRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ForgotUsernameRequest)
    end
  end
