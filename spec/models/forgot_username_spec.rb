...
# Unit tests for ClickSend::ForgotUsername
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ForgotUsername do
  #let(:instance) { ClickSend::ForgotUsername.new }

  describe 'test an instance of ForgotUsername' do
    it 'should create an instance of ForgotUsername' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ForgotUsername)
    end
  end
