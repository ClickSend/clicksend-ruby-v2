...
# Unit tests for ClickSend::GenerateNewApiKeyData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GenerateNewApiKeyData do
  #let(:instance) { ClickSend::GenerateNewApiKeyData.new }

  describe 'test an instance of GenerateNewApiKeyData' do
    it 'should create an instance of GenerateNewApiKeyData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GenerateNewApiKeyData)
    end
  end
