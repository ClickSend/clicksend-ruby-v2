...
# Unit tests for ClickSend::GenerateNewApiKeyRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GenerateNewApiKeyRequest do
  #let(:instance) { ClickSend::GenerateNewApiKeyRequest.new }

  describe 'test an instance of GenerateNewApiKeyRequest' do
    it 'should create an instance of GenerateNewApiKeyRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GenerateNewApiKeyRequest)
    end
  end
