...
# Unit tests for ClickSend::GenerateNewApiKey
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GenerateNewApiKey do
  #let(:instance) { ClickSend::GenerateNewApiKey.new }

  describe 'test an instance of GenerateNewApiKey' do
    it 'should create an instance of GenerateNewApiKey' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GenerateNewApiKey)
    end
  end
