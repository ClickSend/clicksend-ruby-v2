...
# Unit tests for ClickSend::GetAllDeliveryIssuesData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetAllDeliveryIssuesData do
  #let(:instance) { ClickSend::GetAllDeliveryIssuesData.new }

  describe 'test an instance of GetAllDeliveryIssuesData' do
    it 'should create an instance of GetAllDeliveryIssuesData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetAllDeliveryIssuesData)
    end
  end
