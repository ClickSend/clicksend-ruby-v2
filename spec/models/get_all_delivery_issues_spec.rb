...
# Unit tests for ClickSend::GetAllDeliveryIssues
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetAllDeliveryIssues do
  #let(:instance) { ClickSend::GetAllDeliveryIssues.new }

  describe 'test an instance of GetAllDeliveryIssues' do
    it 'should create an instance of GetAllDeliveryIssues' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetAllDeliveryIssues)
    end
  end
