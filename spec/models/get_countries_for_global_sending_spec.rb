...
# Unit tests for ClickSend::GetCountriesForGlobalSending
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetCountriesForGlobalSending do
  #let(:instance) { ClickSend::GetCountriesForGlobalSending.new }

  describe 'test an instance of GetCountriesForGlobalSending' do
    it 'should create an instance of GetCountriesForGlobalSending' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetCountriesForGlobalSending)
    end
  end
