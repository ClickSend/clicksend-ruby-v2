...
# Unit tests for ClickSend::GetDefaultSenderDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetDefaultSenderDetails do
  #let(:instance) { ClickSend::GetDefaultSenderDetails.new }

  describe 'test an instance of GetDefaultSenderDetails' do
    it 'should create an instance of GetDefaultSenderDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetDefaultSenderDetails)
    end
  end
