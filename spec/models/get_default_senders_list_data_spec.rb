...
# Unit tests for ClickSend::GetDefaultSendersListData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetDefaultSendersListData do
  #let(:instance) { ClickSend::GetDefaultSendersListData.new }

  describe 'test an instance of GetDefaultSendersListData' do
    it 'should create an instance of GetDefaultSendersListData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetDefaultSendersListData)
    end
  end
  ...
  describe 'test attribute "self_page_url"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
