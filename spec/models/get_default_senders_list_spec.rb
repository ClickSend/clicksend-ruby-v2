...
# Unit tests for ClickSend::GetDefaultSendersList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetDefaultSendersList do
  #let(:instance) { ClickSend::GetDefaultSendersList.new }

  describe 'test an instance of GetDefaultSendersList' do
    it 'should create an instance of GetDefaultSendersList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetDefaultSendersList)
    end
  end
