...
# Unit tests for ClickSend::GetSpecificContact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetSpecificContact do
  #let(:instance) { ClickSend::GetSpecificContact.new }

  describe 'test an instance of GetSpecificContact' do
    it 'should create an instance of GetSpecificContact' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetSpecificContact)
    end
  end
