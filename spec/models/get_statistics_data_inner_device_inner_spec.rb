...
# Unit tests for ClickSend::GetStatisticsDataInnerDeviceInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetStatisticsDataInnerDeviceInner do
  #let(:instance) { ClickSend::GetStatisticsDataInnerDeviceInner.new }

  describe 'test an instance of GetStatisticsDataInnerDeviceInner' do
    it 'should create an instance of GetStatisticsDataInnerDeviceInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetStatisticsDataInnerDeviceInner)
    end
  end
