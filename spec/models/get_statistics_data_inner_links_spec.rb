...
# Unit tests for ClickSend::GetStatisticsDataInnerLinks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetStatisticsDataInnerLinks do
  #let(:instance) { ClickSend::GetStatisticsDataInnerLinks.new }

  describe 'test an instance of GetStatisticsDataInnerLinks' do
    it 'should create an instance of GetStatisticsDataInnerLinks' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetStatisticsDataInnerLinks)
    end
  end
  ...
  describe 'test attribute "unopened"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
