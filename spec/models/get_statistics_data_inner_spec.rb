...
# Unit tests for ClickSend::GetStatisticsDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetStatisticsDataInner do
  #let(:instance) { ClickSend::GetStatisticsDataInner.new }

  describe 'test an instance of GetStatisticsDataInner' do
    it 'should create an instance of GetStatisticsDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetStatisticsDataInner)
    end
  end

  describe 'test attribute "long_url_id"' do
    it 'should work' do
