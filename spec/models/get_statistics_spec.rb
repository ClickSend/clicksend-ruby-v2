...
# Unit tests for ClickSend::GetStatistics
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetStatistics do
  #let(:instance) { ClickSend::GetStatistics.new }

  describe 'test an instance of GetStatistics' do
    it 'should create an instance of GetStatistics' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetStatistics)
    end
  end
