...
# Unit tests for ClickSend::GetTrackingDataInnerContact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetTrackingDataInnerContact do
  #let(:instance) { ClickSend::GetTrackingDataInnerContact.new }

  describe 'test an instance of GetTrackingDataInnerContact' do
    it 'should create an instance of GetTrackingDataInnerContact' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetTrackingDataInnerContact)
    end
  end
