...
# Unit tests for ClickSend::GetTracking
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetTracking do
  #let(:instance) { ClickSend::GetTracking.new }

  describe 'test an instance of GetTracking' do
    it 'should create an instance of GetTracking' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetTracking)
    end
  end
