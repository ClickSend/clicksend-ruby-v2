...
# Unit tests for ClickSend::GetVoiceHistoryData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetVoiceHistoryData do
  #let(:instance) { ClickSend::GetVoiceHistoryData.new }

  describe 'test an instance of GetVoiceHistoryData' do
    it 'should create an instance of GetVoiceHistoryData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetVoiceHistoryData)
    end
  end
