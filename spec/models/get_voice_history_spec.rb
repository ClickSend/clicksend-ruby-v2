...
# Unit tests for ClickSend::GetVoiceHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GetVoiceHistory do
  #let(:instance) { ClickSend::GetVoiceHistory.new }

  describe 'test an instance of GetVoiceHistory' do
    it 'should create an instance of GetVoiceHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GetVoiceHistory)
    end
  end
