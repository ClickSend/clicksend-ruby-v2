...
# Unit tests for ClickSend::GlobalSendingRegistrationStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::GlobalSendingRegistrationStatus do
  #let(:instance) { ClickSend::GlobalSendingRegistrationStatus.new }

  describe 'test an instance of GlobalSendingRegistrationStatus' do
    it 'should create an instance of GlobalSendingRegistrationStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::GlobalSendingRegistrationStatus)
    end
  end
