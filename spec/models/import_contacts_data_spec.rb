...
# Unit tests for ClickSend::ImportContactsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ImportContactsData do
  #let(:instance) { ClickSend::ImportContactsData.new }

  describe 'test an instance of ImportContactsData' do
    it 'should create an instance of ImportContactsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ImportContactsData)
    end
  end
