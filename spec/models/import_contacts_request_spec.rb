...
# Unit tests for ClickSend::ImportContactsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ImportContactsRequest do
  #let(:instance) { ClickSend::ImportContactsRequest.new }

  describe 'test an instance of ImportContactsRequest' do
    it 'should create an instance of ImportContactsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ImportContactsRequest)
    end
  end
