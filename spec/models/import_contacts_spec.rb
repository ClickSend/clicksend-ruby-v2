...
# Unit tests for ClickSend::ImportContacts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ImportContacts do
  #let(:instance) { ClickSend::ImportContacts.new }

  describe 'test an instance of ImportContacts' do
    it 'should create an instance of ImportContacts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ImportContacts)
    end
  end
