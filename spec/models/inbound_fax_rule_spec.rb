...
# Unit tests for ClickSend::InboundFaxRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::InboundFaxRule do
  #let(:instance) { ClickSend::InboundFaxRule.new }

  describe 'test an instance of InboundFaxRule' do
    it 'should create an instance of InboundFaxRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::InboundFaxRule)
    end
  end
