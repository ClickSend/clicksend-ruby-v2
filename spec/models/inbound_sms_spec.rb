...
# Unit tests for ClickSend::InboundSms
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::InboundSms do
  #let(:instance) { ClickSend::InboundSms.new }

  describe 'test an instance of InboundSms' do
    it 'should create an instance of InboundSms' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::InboundSms)
    end
  end
