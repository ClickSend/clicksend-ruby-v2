...
# Unit tests for ClickSend::InboundSmsTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::InboundSmsTest do
  #let(:instance) { ClickSend::InboundSmsTest.new }

  describe 'test an instance of InboundSmsTest' do
    it 'should create an instance of InboundSmsTest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::InboundSmsTest)
    end
  end

  describe 'test attribute "timestamp_send"' do
    it 'should work' do
  ...
  describe 'test attribute "original_body"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "_keyword"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
