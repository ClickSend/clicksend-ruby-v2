...
# Unit tests for ClickSend::ListAlphaTags
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ListAlphaTags do
  #let(:instance) { ClickSend::ListAlphaTags.new }

  describe 'test an instance of ListAlphaTags' do
    it 'should create an instance of ListAlphaTags' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ListAlphaTags)
    end
  end

  describe 'test attribute "alpha_tags"' do
    it 'should work' do
