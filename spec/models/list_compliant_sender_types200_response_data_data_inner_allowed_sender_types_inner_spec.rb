...
# Unit tests for ClickSend::ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner do
  #let(:instance) { ClickSend::ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner.new }

  describe 'test an instance of ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner' do
    it 'should create an instance of ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ListCompliantSenderTypes200ResponseDataDataInnerAllowedSenderTypesInner)
    end
  end
  ...
  describe 'test attribute "allowed_sender_countries"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
