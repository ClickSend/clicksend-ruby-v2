...
# Unit tests for ClickSend::ListCompliantSenderTypes200ResponseDataDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ListCompliantSenderTypes200ResponseDataDataInner do
  #let(:instance) { ClickSend::ListCompliantSenderTypes200ResponseDataDataInner.new }

  describe 'test an instance of ListCompliantSenderTypes200ResponseDataDataInner' do
    it 'should create an instance of ListCompliantSenderTypes200ResponseDataDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ListCompliantSenderTypes200ResponseDataDataInner)
    end
  end
  ...
  describe 'test attribute "blocked_sender_types"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "allowed_sender_types"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
