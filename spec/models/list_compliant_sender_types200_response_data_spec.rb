...
# Unit tests for ClickSend::ListCompliantSenderTypes200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ListCompliantSenderTypes200ResponseData do
  #let(:instance) { ClickSend::ListCompliantSenderTypes200ResponseData.new }

  describe 'test an instance of ListCompliantSenderTypes200ResponseData' do
    it 'should create an instance of ListCompliantSenderTypes200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ListCompliantSenderTypes200ResponseData)
    end
  end
