...
# Unit tests for ClickSend::ListCompliantSenderTypes200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ListCompliantSenderTypes200Response do
  #let(:instance) { ClickSend::ListCompliantSenderTypes200Response.new }

  describe 'test an instance of ListCompliantSenderTypes200Response' do
    it 'should create an instance of ListCompliantSenderTypes200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ListCompliantSenderTypes200Response)
    end
  end
