...
# Unit tests for ClickSend::ListCountriesDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ListCountriesDataInner do
  #let(:instance) { ClickSend::ListCountriesDataInner.new }

  describe 'test an instance of ListCountriesDataInner' do
    it 'should create an instance of ListCountriesDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ListCountriesDataInner)
    end
  end
