...
# Unit tests for ClickSend::ListCountries
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ListCountries do
  #let(:instance) { ClickSend::ListCountries.new }

  describe 'test an instance of ListCountries' do
    it 'should create an instance of ListCountries' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ListCountries)
    end
  end
