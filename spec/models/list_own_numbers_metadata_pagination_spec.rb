...
# Unit tests for ClickSend::ListOwnNumbersMetadataPagination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ListOwnNumbersMetadataPagination do
  #let(:instance) { ClickSend::ListOwnNumbersMetadataPagination.new }

  describe 'test an instance of ListOwnNumbersMetadataPagination' do
    it 'should create an instance of ListOwnNumbersMetadataPagination' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ListOwnNumbersMetadataPagination)
    end
  end
