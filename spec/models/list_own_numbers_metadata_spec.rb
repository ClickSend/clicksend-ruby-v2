...
# Unit tests for ClickSend::ListOwnNumbersMetadata
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ListOwnNumbersMetadata do
  #let(:instance) { ClickSend::ListOwnNumbersMetadata.new }

  describe 'test an instance of ListOwnNumbersMetadata' do
    it 'should create an instance of ListOwnNumbersMetadata' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ListOwnNumbersMetadata)
    end
  end
