...
# Unit tests for ClickSend::ListOwnNumbers
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ListOwnNumbers do
  #let(:instance) { ClickSend::ListOwnNumbers.new }

  describe 'test an instance of ListOwnNumbers' do
    it 'should create an instance of ListOwnNumbers' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ListOwnNumbers)
    end
  end

  describe 'test attribute "own_numbers"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "_metadata"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
