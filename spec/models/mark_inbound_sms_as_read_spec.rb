...
# Unit tests for ClickSend::MarkInboundSmsAsRead
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::MarkInboundSmsAsRead do
  #let(:instance) { ClickSend::MarkInboundSmsAsRead.new }

  describe 'test an instance of MarkInboundSmsAsRead' do
    it 'should create an instance of MarkInboundSmsAsRead' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::MarkInboundSmsAsRead)
    end
  end
