...
# Unit tests for ClickSend::MarkSmsReceiptAsReadRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::MarkSmsReceiptAsReadRequest do
  #let(:instance) { ClickSend::MarkSmsReceiptAsReadRequest.new }

  describe 'test an instance of MarkSmsReceiptAsReadRequest' do
    it 'should create an instance of MarkSmsReceiptAsReadRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::MarkSmsReceiptAsReadRequest)
    end
  end
