...
# Unit tests for ClickSend::MarkSmsReceiptAsRead
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::MarkSmsReceiptAsRead do
  #let(:instance) { ClickSend::MarkSmsReceiptAsRead.new }

  describe 'test an instance of MarkSmsReceiptAsRead' do
    it 'should create an instance of MarkSmsReceiptAsRead' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::MarkSmsReceiptAsRead)
    end
  end
