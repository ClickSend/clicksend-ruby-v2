...
# Unit tests for ClickSend::MarkSpecificInboundSmsMessageAsRead
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::MarkSpecificInboundSmsMessageAsRead do
  #let(:instance) { ClickSend::MarkSpecificInboundSmsMessageAsRead.new }

  describe 'test an instance of MarkSpecificInboundSmsMessageAsRead' do
    it 'should create an instance of MarkSpecificInboundSmsMessageAsRead' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::MarkSpecificInboundSmsMessageAsRead)
    end
  end
  ...
  describe 'test attribute "response_msg"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
