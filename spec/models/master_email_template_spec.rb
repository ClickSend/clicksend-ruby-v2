...
# Unit tests for ClickSend::MasterEmailTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::MasterEmailTemplate do
  #let(:instance) { ClickSend::MasterEmailTemplate.new }

  describe 'test an instance of MasterEmailTemplate' do
    it 'should create an instance of MasterEmailTemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::MasterEmailTemplate)
    end
  end
