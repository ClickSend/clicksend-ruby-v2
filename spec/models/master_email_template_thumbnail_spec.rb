...
# Unit tests for ClickSend::MasterEmailTemplateThumbnail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::MasterEmailTemplateThumbnail do
  #let(:instance) { ClickSend::MasterEmailTemplateThumbnail.new }

  describe 'test an instance of MasterEmailTemplateThumbnail' do
    it 'should create an instance of MasterEmailTemplateThumbnail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::MasterEmailTemplateThumbnail)
    end
  end
