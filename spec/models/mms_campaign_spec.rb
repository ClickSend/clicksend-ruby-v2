...
# Unit tests for ClickSend::MmsCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::MmsCampaign do
  #let(:instance) { ClickSend::MmsCampaign.new }

  describe 'test an instance of MmsCampaign' do
    it 'should create an instance of MmsCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::MmsCampaign)
    end
  end

  describe 'test attribute "mms_campaign_id"' do
    it 'should work' do
  ...
  describe 'test attribute "_total_count"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
