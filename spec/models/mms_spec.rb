...
# Unit tests for ClickSend::Mms
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::Mms do
  #let(:instance) { ClickSend::Mms.new }

  describe 'test an instance of Mms' do
    it 'should create an instance of Mms' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::Mms)
    end
  end
