...
# Unit tests for ClickSend::Model400Error
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::Model400Error do
  #let(:instance) { ClickSend::Model400Error.new }

  describe 'test an instance of Model400Error' do
    it 'should create an instance of Model400Error' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::Model400Error)
    end
  end
