...
# Unit tests for ClickSend::OwnNumber
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::OwnNumber do
  #let(:instance) { ClickSend::OwnNumber.new }

  describe 'test an instance of OwnNumber' do
    it 'should create an instance of OwnNumber' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::OwnNumber)
    end
  end
