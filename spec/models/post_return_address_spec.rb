...
# Unit tests for ClickSend::PostReturnAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::PostReturnAddress do
  #let(:instance) { ClickSend::PostReturnAddress.new }

  describe 'test an instance of PostReturnAddress' do
    it 'should create an instance of PostReturnAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::PostReturnAddress)
    end
  end
