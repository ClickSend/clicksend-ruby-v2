...
# Unit tests for ClickSend::PostcardRecipientReturnAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::PostcardRecipientReturnAddress do
  #let(:instance) { ClickSend::PostcardRecipientReturnAddress.new }

  describe 'test an instance of PostcardRecipientReturnAddress' do
    it 'should create an instance of PostcardRecipientReturnAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::PostcardRecipientReturnAddress)
    end
  end
