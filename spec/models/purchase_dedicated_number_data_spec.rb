...
# Unit tests for ClickSend::PurchaseDedicatedNumberData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::PurchaseDedicatedNumberData do
  #let(:instance) { ClickSend::PurchaseDedicatedNumberData.new }

  describe 'test an instance of PurchaseDedicatedNumberData' do
    it 'should create an instance of PurchaseDedicatedNumberData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::PurchaseDedicatedNumberData)
    end
  end
  ...
  describe 'test attribute "_price_setup"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "_price_monthly"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
