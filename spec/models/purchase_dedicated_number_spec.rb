...
# Unit tests for ClickSend::PurchaseDedicatedNumber
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::PurchaseDedicatedNumber do
  #let(:instance) { ClickSend::PurchaseDedicatedNumber.new }

  describe 'test an instance of PurchaseDedicatedNumber' do
    it 'should create an instance of PurchaseDedicatedNumber' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::PurchaseDedicatedNumber)
    end
  end
