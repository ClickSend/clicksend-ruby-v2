...
# Unit tests for ClickSend::PurchaseRechargePackageData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::PurchaseRechargePackageData do
  #let(:instance) { ClickSend::PurchaseRechargePackageData.new }

  describe 'test an instance of PurchaseRechargePackageData' do
    it 'should create an instance of PurchaseRechargePackageData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::PurchaseRechargePackageData)
    end
  end
  ...
  describe 'test attribute "amount_aud"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
