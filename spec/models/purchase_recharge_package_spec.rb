...
# Unit tests for ClickSend::PurchaseRechargePackage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::PurchaseRechargePackage do
  #let(:instance) { ClickSend::PurchaseRechargePackage.new }

  describe 'test an instance of PurchaseRechargePackage' do
    it 'should create an instance of PurchaseRechargePackage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::PurchaseRechargePackage)
    end
  end
