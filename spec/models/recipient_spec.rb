...
# Unit tests for ClickSend::Recipient
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::Recipient do
  #let(:instance) { ClickSend::Recipient.new }

  describe 'test an instance of Recipient' do
    it 'should create an instance of Recipient' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::Recipient)
    end
  end
  ...
  describe 'test attribute "post_pages"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
