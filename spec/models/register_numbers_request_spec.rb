...
# Unit tests for ClickSend::RegisterNumbersRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RegisterNumbersRequest do
  #let(:instance) { ClickSend::RegisterNumbersRequest.new }

  describe 'test an instance of RegisterNumbersRequest' do
    it 'should create an instance of RegisterNumbersRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RegisterNumbersRequest)
    end
  end
  ...
  describe 'test attribute "sample_message"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "primary_use_case"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
