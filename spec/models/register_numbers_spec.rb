...
# Unit tests for ClickSend::RegisterNumbers
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RegisterNumbers do
  #let(:instance) { ClickSend::RegisterNumbers.new }

  describe 'test an instance of RegisterNumbers' do
    it 'should create an instance of RegisterNumbers' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RegisterNumbers)
    end
  end
