...
# Unit tests for ClickSend::RemoveDuplicateContactsRequestFields
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RemoveDuplicateContactsRequestFields do
  #let(:instance) { ClickSend::RemoveDuplicateContactsRequestFields.new }

  describe 'test an instance of RemoveDuplicateContactsRequestFields' do
    it 'should create an instance of RemoveDuplicateContactsRequestFields' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RemoveDuplicateContactsRequestFields)
    end
  end
