...
# Unit tests for ClickSend::RemoveDuplicateContactsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RemoveDuplicateContactsRequest do
  #let(:instance) { ClickSend::RemoveDuplicateContactsRequest.new }

  describe 'test an instance of RemoveDuplicateContactsRequest' do
    it 'should create an instance of RemoveDuplicateContactsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RemoveDuplicateContactsRequest)
    end
  end
