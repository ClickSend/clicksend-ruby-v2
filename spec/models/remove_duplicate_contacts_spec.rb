...
# Unit tests for ClickSend::RemoveDuplicateContacts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RemoveDuplicateContacts do
  #let(:instance) { ClickSend::RemoveDuplicateContacts.new }

  describe 'test an instance of RemoveDuplicateContacts' do
    it 'should create an instance of RemoveDuplicateContacts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RemoveDuplicateContacts)
    end
  end
