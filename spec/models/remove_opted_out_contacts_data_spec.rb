...
# Unit tests for ClickSend::RemoveOptedOutContactsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RemoveOptedOutContactsData do
  #let(:instance) { ClickSend::RemoveOptedOutContactsData.new }

  describe 'test an instance of RemoveOptedOutContactsData' do
    it 'should create an instance of RemoveOptedOutContactsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RemoveOptedOutContactsData)
    end
  end
