...
# Unit tests for ClickSend::RemoveOptedOutContacts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RemoveOptedOutContacts do
  #let(:instance) { ClickSend::RemoveOptedOutContacts.new }

  describe 'test an instance of RemoveOptedOutContacts' do
    it 'should create an instance of RemoveOptedOutContacts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RemoveOptedOutContacts)
    end
  end
