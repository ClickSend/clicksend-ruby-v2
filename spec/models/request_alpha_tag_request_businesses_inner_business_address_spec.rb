...
# Unit tests for ClickSend::RequestAlphaTagRequestBusinessesInnerBusinessAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RequestAlphaTagRequestBusinessesInnerBusinessAddress do
  #let(:instance) { ClickSend::RequestAlphaTagRequestBusinessesInnerBusinessAddress.new }

  describe 'test an instance of RequestAlphaTagRequestBusinessesInnerBusinessAddress' do
    it 'should create an instance of RequestAlphaTagRequestBusinessesInnerBusinessAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RequestAlphaTagRequestBusinessesInnerBusinessAddress)
    end
  end

  describe 'test attribute "addr_line1"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "addr_line2"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
