...
# Unit tests for ClickSend::RequestAlphaTagRequestBusinessesInnerBusinessInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RequestAlphaTagRequestBusinessesInnerBusinessInfo do
  #let(:instance) { ClickSend::RequestAlphaTagRequestBusinessesInnerBusinessInfo.new }

  describe 'test an instance of RequestAlphaTagRequestBusinessesInnerBusinessInfo' do
    it 'should create an instance of RequestAlphaTagRequestBusinessesInnerBusinessInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RequestAlphaTagRequestBusinessesInnerBusinessInfo)
    end
  end
