...
# Unit tests for ClickSend::RequestAlphaTagRequestBusinessesInnerPartnerRepresentative
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RequestAlphaTagRequestBusinessesInnerPartnerRepresentative do
  #let(:instance) { ClickSend::RequestAlphaTagRequestBusinessesInnerPartnerRepresentative.new }

  describe 'test an instance of RequestAlphaTagRequestBusinessesInnerPartnerRepresentative' do
    it 'should create an instance of RequestAlphaTagRequestBusinessesInnerPartnerRepresentative' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RequestAlphaTagRequestBusinessesInnerPartnerRepresentative)
    end
  end
