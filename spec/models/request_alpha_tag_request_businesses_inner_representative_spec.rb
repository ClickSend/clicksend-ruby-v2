...
# Unit tests for ClickSend::RequestAlphaTagRequestBusinessesInnerRepresentative
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RequestAlphaTagRequestBusinessesInnerRepresentative do
  #let(:instance) { ClickSend::RequestAlphaTagRequestBusinessesInnerRepresentative.new }

  describe 'test an instance of RequestAlphaTagRequestBusinessesInnerRepresentative' do
    it 'should create an instance of RequestAlphaTagRequestBusinessesInnerRepresentative' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RequestAlphaTagRequestBusinessesInnerRepresentative)
    end
  end
