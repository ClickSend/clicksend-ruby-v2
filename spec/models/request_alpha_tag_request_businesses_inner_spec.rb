...
# Unit tests for ClickSend::RequestAlphaTagRequestBusinessesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RequestAlphaTagRequestBusinessesInner do
  #let(:instance) { ClickSend::RequestAlphaTagRequestBusinessesInner.new }

  describe 'test an instance of RequestAlphaTagRequestBusinessesInner' do
    it 'should create an instance of RequestAlphaTagRequestBusinessesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RequestAlphaTagRequestBusinessesInner)
    end
  end
  ...
  describe 'test attribute "business_relationship"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["PRIMARY", "ENTITY_ASSOCIATE"])
      # validator.allowable_values.each do |value|
      #   expect { instance.business_relationship = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "partner_business_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "partner_abn"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "partner_business_info"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "partner_business_address"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "partner_representative"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
