...
# Unit tests for ClickSend::RequestAlphaTagRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RequestAlphaTagRequest do
  #let(:instance) { ClickSend::RequestAlphaTagRequest.new }

  describe 'test an instance of RequestAlphaTagRequest' do
    it 'should create an instance of RequestAlphaTagRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RequestAlphaTagRequest)
    end
  end

  describe 'test attribute "alpha_tag"' do
    it 'should work' do
  ...
  describe 'test attribute "countries"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["AU"])
      # validator.allowable_values.each do |value|
      #   expect { instance.countries = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "businesses"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
