...
# Unit tests for ClickSend::RequestOwnNumberVerificationOtpRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RequestOwnNumberVerificationOtpRequest do
  #let(:instance) { ClickSend::RequestOwnNumberVerificationOtpRequest.new }

  describe 'test an instance of RequestOwnNumberVerificationOtpRequest' do
    it 'should create an instance of RequestOwnNumberVerificationOtpRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RequestOwnNumberVerificationOtpRequest)
    end
  end
