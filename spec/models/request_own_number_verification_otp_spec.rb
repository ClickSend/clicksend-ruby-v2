...
# Unit tests for ClickSend::RequestOwnNumberVerificationOtp
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::RequestOwnNumberVerificationOtp do
  #let(:instance) { ClickSend::RequestOwnNumberVerificationOtp.new }

  describe 'test an instance of RequestOwnNumberVerificationOtp' do
    it 'should create an instance of RequestOwnNumberVerificationOtp' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::RequestOwnNumberVerificationOtp)
    end
  end
  ...
  describe 'test attribute "own_number_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "remaining_attempts"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
