...
# Unit tests for ClickSend::ResellerAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ResellerAccount do
  #let(:instance) { ClickSend::ResellerAccount.new }

  describe 'test an instance of ResellerAccount' do
    it 'should create an instance of ResellerAccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ResellerAccount)
    end
  end
