...
# Unit tests for ClickSend::ResellerTransferCredit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ResellerTransferCredit do
  #let(:instance) { ClickSend::ResellerTransferCredit.new }

  describe 'test an instance of ResellerTransferCredit' do
    it 'should create an instance of ResellerTransferCredit' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ResellerTransferCredit)
    end
  end
