...
# Unit tests for ClickSend::SelectCountriesForGlobalSendingRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SelectCountriesForGlobalSendingRequest do
  #let(:instance) { ClickSend::SelectCountriesForGlobalSendingRequest.new }

  describe 'test an instance of SelectCountriesForGlobalSendingRequest' do
    it 'should create an instance of SelectCountriesForGlobalSendingRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SelectCountriesForGlobalSendingRequest)
    end
  end
