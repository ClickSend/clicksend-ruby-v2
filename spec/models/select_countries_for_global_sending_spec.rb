...
# Unit tests for ClickSend::SelectCountriesForGlobalSending
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SelectCountriesForGlobalSending do
  #let(:instance) { ClickSend::SelectCountriesForGlobalSending.new }

  describe 'test an instance of SelectCountriesForGlobalSending' do
    it 'should create an instance of SelectCountriesForGlobalSending' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SelectCountriesForGlobalSending)
    end
  end
