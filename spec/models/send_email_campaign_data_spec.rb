...
# Unit tests for ClickSend::SendEmailCampaignData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendEmailCampaignData do
  #let(:instance) { ClickSend::SendEmailCampaignData.new }

  describe 'test an instance of SendEmailCampaignData' do
    it 'should create an instance of SendEmailCampaignData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendEmailCampaignData)
    end
  end

  describe 'test attribute "totlal_count"' do
    it 'should work' do
