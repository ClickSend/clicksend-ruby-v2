...
# Unit tests for ClickSend::SendEmailCampaignRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendEmailCampaignRequest do
  #let(:instance) { ClickSend::SendEmailCampaignRequest.new }

  describe 'test an instance of SendEmailCampaignRequest' do
    it 'should create an instance of SendEmailCampaignRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendEmailCampaignRequest)
    end
  end
