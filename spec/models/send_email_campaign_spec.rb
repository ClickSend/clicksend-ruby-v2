...
# Unit tests for ClickSend::SendEmailCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendEmailCampaign do
  #let(:instance) { ClickSend::SendEmailCampaign.new }

  describe 'test an instance of SendEmailCampaign' do
    it 'should create an instance of SendEmailCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendEmailCampaign)
    end
  end
