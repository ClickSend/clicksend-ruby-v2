...
# Unit tests for ClickSend::SendEmailRequestAttachmentsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendEmailRequestAttachmentsInner do
  #let(:instance) { ClickSend::SendEmailRequestAttachmentsInner.new }

  describe 'test an instance of SendEmailRequestAttachmentsInner' do
    it 'should create an instance of SendEmailRequestAttachmentsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendEmailRequestAttachmentsInner)
    end
  end
