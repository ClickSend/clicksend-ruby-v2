...
# Unit tests for ClickSend::SendEmailRequestFrom
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendEmailRequestFrom do
  #let(:instance) { ClickSend::SendEmailRequestFrom.new }

  describe 'test an instance of SendEmailRequestFrom' do
    it 'should create an instance of SendEmailRequestFrom' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendEmailRequestFrom)
    end
  end
