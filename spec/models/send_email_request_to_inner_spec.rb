...
# Unit tests for ClickSend::SendEmailRequestToInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendEmailRequestToInner do
  #let(:instance) { ClickSend::SendEmailRequestToInner.new }

  describe 'test an instance of SendEmailRequestToInner' do
    it 'should create an instance of SendEmailRequestToInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendEmailRequestToInner)
    end
  end
