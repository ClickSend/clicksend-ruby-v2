...
# Unit tests for ClickSend::SendEmail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendEmail do
  #let(:instance) { ClickSend::SendEmail.new }

  describe 'test an instance of SendEmail' do
    it 'should create an instance of SendEmail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendEmail)
    end
  end
