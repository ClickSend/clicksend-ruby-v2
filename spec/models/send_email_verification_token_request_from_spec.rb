...
# Unit tests for ClickSend::SendEmailVerificationTokenRequestFrom
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendEmailVerificationTokenRequestFrom do
  #let(:instance) { ClickSend::SendEmailVerificationTokenRequestFrom.new }

  describe 'test an instance of SendEmailVerificationTokenRequestFrom' do
    it 'should create an instance of SendEmailVerificationTokenRequestFrom' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendEmailVerificationTokenRequestFrom)
    end
  end
