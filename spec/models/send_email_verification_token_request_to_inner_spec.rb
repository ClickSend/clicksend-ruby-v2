...
# Unit tests for ClickSend::SendEmailVerificationTokenRequestToInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendEmailVerificationTokenRequestToInner do
  #let(:instance) { ClickSend::SendEmailVerificationTokenRequestToInner.new }

  describe 'test an instance of SendEmailVerificationTokenRequestToInner' do
    it 'should create an instance of SendEmailVerificationTokenRequestToInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendEmailVerificationTokenRequestToInner)
    end
  end
