...
# Unit tests for ClickSend::SendEmailVerificationToken
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendEmailVerificationToken do
  #let(:instance) { ClickSend::SendEmailVerificationToken.new }

  describe 'test an instance of SendEmailVerificationToken' do
    it 'should create an instance of SendEmailVerificationToken' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendEmailVerificationToken)
    end
  end
