...
# Unit tests for ClickSend::SendFaxData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendFaxData do
  #let(:instance) { ClickSend::SendFaxData.new }

  describe 'test an instance of SendFaxData' do
    it 'should create an instance of SendFaxData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendFaxData)
    end
  end
