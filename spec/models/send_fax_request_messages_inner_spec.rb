...
# Unit tests for ClickSend::SendFaxRequestMessagesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendFaxRequestMessagesInner do
  #let(:instance) { ClickSend::SendFaxRequestMessagesInner.new }

  describe 'test an instance of SendFaxRequestMessagesInner' do
    it 'should create an instance of SendFaxRequestMessagesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendFaxRequestMessagesInner)
    end
  end
