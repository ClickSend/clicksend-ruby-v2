...
# Unit tests for ClickSend::SendFaxRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendFaxRequest do
  #let(:instance) { ClickSend::SendFaxRequest.new }

  describe 'test an instance of SendFaxRequest' do
    it 'should create an instance of SendFaxRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendFaxRequest)
    end
  end
