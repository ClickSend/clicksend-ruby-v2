...
# Unit tests for ClickSend::SendFax
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendFax do
  #let(:instance) { ClickSend::SendFax.new }

  describe 'test an instance of SendFax' do
    it 'should create an instance of SendFax' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendFax)
    end
  end
