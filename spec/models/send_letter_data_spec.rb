...
# Unit tests for ClickSend::SendLetterData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendLetterData do
  #let(:instance) { ClickSend::SendLetterData.new }

  describe 'test an instance of SendLetterData' do
    it 'should create an instance of SendLetterData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendLetterData)
    end
  end
