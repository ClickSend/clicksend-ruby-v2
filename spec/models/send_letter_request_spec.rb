...
# Unit tests for ClickSend::SendLetterRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendLetterRequest do
  #let(:instance) { ClickSend::SendLetterRequest.new }

  describe 'test an instance of SendLetterRequest' do
    it 'should create an instance of SendLetterRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendLetterRequest)
    end
  end
