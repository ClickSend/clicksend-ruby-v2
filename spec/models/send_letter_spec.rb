...
# Unit tests for ClickSend::SendLetter
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendLetter do
  #let(:instance) { ClickSend::SendLetter.new }

  describe 'test an instance of SendLetter' do
    it 'should create an instance of SendLetter' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendLetter)
    end
  end
