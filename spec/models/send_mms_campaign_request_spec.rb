...
# Unit tests for ClickSend::SendMmsCampaignRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendMmsCampaignRequest do
  #let(:instance) { ClickSend::SendMmsCampaignRequest.new }

  describe 'test an instance of SendMmsCampaignRequest' do
    it 'should create an instance of SendMmsCampaignRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendMmsCampaignRequest)
    end
  end
