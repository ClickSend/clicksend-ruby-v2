...
# Unit tests for ClickSend::SendMmsCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendMmsCampaign do
  #let(:instance) { ClickSend::SendMmsCampaign.new }

  describe 'test an instance of SendMmsCampaign' do
    it 'should create an instance of SendMmsCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendMmsCampaign)
    end
  end
