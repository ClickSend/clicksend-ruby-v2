...
# Unit tests for ClickSend::SendMmsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendMmsData do
  #let(:instance) { ClickSend::SendMmsData.new }

  describe 'test an instance of SendMmsData' do
    it 'should create an instance of SendMmsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendMmsData)
    end
  end
