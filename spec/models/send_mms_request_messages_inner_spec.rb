...
# Unit tests for ClickSend::SendMmsRequestMessagesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendMmsRequestMessagesInner do
  #let(:instance) { ClickSend::SendMmsRequestMessagesInner.new }

  describe 'test an instance of SendMmsRequestMessagesInner' do
    it 'should create an instance of SendMmsRequestMessagesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendMmsRequestMessagesInner)
    end
  end
