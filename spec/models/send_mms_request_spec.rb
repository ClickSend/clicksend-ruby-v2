...
# Unit tests for ClickSend::SendMmsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendMmsRequest do
  #let(:instance) { ClickSend::SendMmsRequest.new }

  describe 'test an instance of SendMmsRequest' do
    it 'should create an instance of SendMmsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendMmsRequest)
    end
  end
