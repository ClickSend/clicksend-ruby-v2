...
# Unit tests for ClickSend::SendMms
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendMms do
  #let(:instance) { ClickSend::SendMms.new }

  describe 'test an instance of SendMms' do
    it 'should create an instance of SendMms' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendMms)
    end
  end
