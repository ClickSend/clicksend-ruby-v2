...
# Unit tests for ClickSend::SendPostcardData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendPostcardData do
  #let(:instance) { ClickSend::SendPostcardData.new }

  describe 'test an instance of SendPostcardData' do
    it 'should create an instance of SendPostcardData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendPostcardData)
    end
  end
