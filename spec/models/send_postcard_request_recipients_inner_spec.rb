...
# Unit tests for ClickSend::SendPostcardRequestRecipientsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendPostcardRequestRecipientsInner do
  #let(:instance) { ClickSend::SendPostcardRequestRecipientsInner.new }

  describe 'test an instance of SendPostcardRequestRecipientsInner' do
    it 'should create an instance of SendPostcardRequestRecipientsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendPostcardRequestRecipientsInner)
    end
  end
