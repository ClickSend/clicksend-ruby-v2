...
# Unit tests for ClickSend::SendPostcardRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendPostcardRequest do
  #let(:instance) { ClickSend::SendPostcardRequest.new }

  describe 'test an instance of SendPostcardRequest' do
    it 'should create an instance of SendPostcardRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendPostcardRequest)
    end
  end
