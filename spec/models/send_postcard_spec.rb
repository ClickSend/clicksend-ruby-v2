...
# Unit tests for ClickSend::SendPostcard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendPostcard do
  #let(:instance) { ClickSend::SendPostcard.new }

  describe 'test an instance of SendPostcard' do
    it 'should create an instance of SendPostcard' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendPostcard)
    end
  end
