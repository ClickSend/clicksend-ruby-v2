...
# Unit tests for ClickSend::SendSmsCampaignRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendSmsCampaignRequest do
  #let(:instance) { ClickSend::SendSmsCampaignRequest.new }

  describe 'test an instance of SendSmsCampaignRequest' do
    it 'should create an instance of SendSmsCampaignRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendSmsCampaignRequest)
    end
  end
