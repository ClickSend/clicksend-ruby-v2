...
# Unit tests for ClickSend::SendSmsCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendSmsCampaign do
  #let(:instance) { ClickSend::SendSmsCampaign.new }

  describe 'test an instance of SendSmsCampaign' do
    it 'should create an instance of SendSmsCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendSmsCampaign)
    end
  end
