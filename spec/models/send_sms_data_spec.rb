...
# Unit tests for ClickSend::SendSmsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendSmsData do
  #let(:instance) { ClickSend::SendSmsData.new }

  describe 'test an instance of SendSmsData' do
    it 'should create an instance of SendSmsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendSmsData)
    end
  end
