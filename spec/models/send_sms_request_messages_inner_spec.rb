...
# Unit tests for ClickSend::SendSmsRequestMessagesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendSmsRequestMessagesInner do
  #let(:instance) { ClickSend::SendSmsRequestMessagesInner.new }

  describe 'test an instance of SendSmsRequestMessagesInner' do
    it 'should create an instance of SendSmsRequestMessagesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendSmsRequestMessagesInner)
    end
  end
  ...
  describe 'test attribute "exclude_no_sender_id_recipients"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
