...
# Unit tests for ClickSend::SendSmsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendSmsRequest do
  #let(:instance) { ClickSend::SendSmsRequest.new }

  describe 'test an instance of SendSmsRequest' do
    it 'should create an instance of SendSmsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendSmsRequest)
    end
  end
