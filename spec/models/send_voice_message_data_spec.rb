...
# Unit tests for ClickSend::SendVoiceMessageData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendVoiceMessageData do
  #let(:instance) { ClickSend::SendVoiceMessageData.new }

  describe 'test an instance of SendVoiceMessageData' do
    it 'should create an instance of SendVoiceMessageData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendVoiceMessageData)
    end
  end
