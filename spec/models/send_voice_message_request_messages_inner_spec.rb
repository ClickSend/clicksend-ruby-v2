...
# Unit tests for ClickSend::SendVoiceMessageRequestMessagesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendVoiceMessageRequestMessagesInner do
  #let(:instance) { ClickSend::SendVoiceMessageRequestMessagesInner.new }

  describe 'test an instance of SendVoiceMessageRequestMessagesInner' do
    it 'should create an instance of SendVoiceMessageRequestMessagesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendVoiceMessageRequestMessagesInner)
    end
  end
