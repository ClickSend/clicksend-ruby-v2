...
# Unit tests for ClickSend::SendVoiceMessageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendVoiceMessageRequest do
  #let(:instance) { ClickSend::SendVoiceMessageRequest.new }

  describe 'test an instance of SendVoiceMessageRequest' do
    it 'should create an instance of SendVoiceMessageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendVoiceMessageRequest)
    end
  end
