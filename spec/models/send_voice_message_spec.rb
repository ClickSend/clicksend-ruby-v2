...
# Unit tests for ClickSend::SendVoiceMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendVoiceMessage do
  #let(:instance) { ClickSend::SendVoiceMessage.new }

  describe 'test an instance of SendVoiceMessage' do
    it 'should create an instance of SendVoiceMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendVoiceMessage)
    end
  end
