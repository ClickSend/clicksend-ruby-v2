...
# Unit tests for ClickSend::SendersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SendersInner do
  #let(:instance) { ClickSend::SendersInner.new }

  describe 'test an instance of SendersInner' do
    it 'should create an instance of SendersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SendersInner)
    end
  end
  ...
  describe 'test attribute "sender_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["shared_longcode"])
