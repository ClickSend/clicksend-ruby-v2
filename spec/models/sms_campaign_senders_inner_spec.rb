...
# Unit tests for ClickSend::SmsCampaignSendersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SmsCampaignSendersInner do
  #let(:instance) { ClickSend::SmsCampaignSendersInner.new }

  describe 'test an instance of SmsCampaignSendersInner' do
    it 'should create an instance of SmsCampaignSendersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SmsCampaignSendersInner)
    end
  end
