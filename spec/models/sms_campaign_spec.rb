...
# Unit tests for ClickSend::SmsCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SmsCampaign do
  #let(:instance) { ClickSend::SmsCampaign.new }

  describe 'test an instance of SmsCampaign' do
    it 'should create an instance of SmsCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SmsCampaign)
    end
  end
  ...
  describe 'test attribute "unsubscribe_link"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
