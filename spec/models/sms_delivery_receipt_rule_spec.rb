...
# Unit tests for ClickSend::SmsDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SmsDeliveryReceiptRule do
  #let(:instance) { ClickSend::SmsDeliveryReceiptRule.new }

  describe 'test an instance of SmsDeliveryReceiptRule' do
    it 'should create an instance of SmsDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SmsDeliveryReceiptRule)
    end
  end
