...
# Unit tests for ClickSend::SmsInboundRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SmsInboundRule do
  #let(:instance) { ClickSend::SmsInboundRule.new }

  describe 'test an instance of SmsInboundRule' do
    it 'should create an instance of SmsInboundRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SmsInboundRule)
    end
  end

  describe 'test attribute "inbound_rule_id"' do
    it 'should work' do
