...
# Unit tests for ClickSend::SmsReceipt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SmsReceipt do
  #let(:instance) { ClickSend::SmsReceipt.new }

  describe 'test an instance of SmsReceipt' do
    it 'should create an instance of SmsReceipt' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SmsReceipt)
    end
  end
