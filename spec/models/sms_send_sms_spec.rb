...
# Unit tests for ClickSend::SmsSendSms
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SmsSendSms do
  #let(:instance) { ClickSend::SmsSendSms.new }

  describe 'test an instance of SmsSendSms' do
    it 'should create an instance of SmsSendSms' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SmsSendSms)
    end
  end
  ...
  describe 'test attribute "is_shared_system_number"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
