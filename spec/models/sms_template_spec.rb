...
# Unit tests for ClickSend::SmsTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SmsTemplate do
  #let(:instance) { ClickSend::SmsTemplate.new }

  describe 'test an instance of SmsTemplate' do
    it 'should create an instance of SmsTemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SmsTemplate)
    end
  end
