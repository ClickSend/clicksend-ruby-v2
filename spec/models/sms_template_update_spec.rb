...
# Unit tests for ClickSend::SmsTemplateUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::SmsTemplateUpdate do
  #let(:instance) { ClickSend::SmsTemplateUpdate.new }

  describe 'test an instance of SmsTemplateUpdate' do
    it 'should create an instance of SmsTemplateUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::SmsTemplateUpdate)
    end
  end
