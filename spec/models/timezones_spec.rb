...
# Unit tests for ClickSend::Timezones
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::Timezones do
  #let(:instance) { ClickSend::Timezones.new }

  describe 'test an instance of Timezones' do
    it 'should create an instance of Timezones' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::Timezones)
    end
  end
