...
# Unit tests for ClickSend::TransactionalEmail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::TransactionalEmail do
  #let(:instance) { ClickSend::TransactionalEmail.new }

  describe 'test an instance of TransactionalEmail' do
    it 'should create an instance of TransactionalEmail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::TransactionalEmail)
    end
  end
  ...
  describe 'test attribute "body_plain_text"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "soft_bounce_count"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "hard_bounce_count"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "_attachments"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
