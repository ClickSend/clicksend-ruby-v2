...
# Unit tests for ClickSend::TransferContactToList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::TransferContactToList do
  #let(:instance) { ClickSend::TransferContactToList.new }

  describe 'test an instance of TransferContactToList' do
    it 'should create an instance of TransferContactToList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::TransferContactToList)
    end
  end
