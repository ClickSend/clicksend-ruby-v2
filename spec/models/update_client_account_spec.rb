...
# Unit tests for ClickSend::UpdateClientAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateClientAccount do
  #let(:instance) { ClickSend::UpdateClientAccount.new }

  describe 'test an instance of UpdateClientAccount' do
    it 'should create an instance of UpdateClientAccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateClientAccount)
    end
  end
