...
# Unit tests for ClickSend::UpdateContact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateContact do
  #let(:instance) { ClickSend::UpdateContact.new }

  describe 'test an instance of UpdateContact' do
    it 'should create an instance of UpdateContact' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateContact)
    end
  end
