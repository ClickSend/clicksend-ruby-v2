...
# Unit tests for ClickSend::UpdateDefaultSenderRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateDefaultSenderRequest do
  #let(:instance) { ClickSend::UpdateDefaultSenderRequest.new }

  describe 'test an instance of UpdateDefaultSenderRequest' do
    it 'should create an instance of UpdateDefaultSenderRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateDefaultSenderRequest)
    end
  end
