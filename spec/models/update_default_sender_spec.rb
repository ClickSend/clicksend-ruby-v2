...
# Unit tests for ClickSend::UpdateDefaultSender
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateDefaultSender do
  #let(:instance) { ClickSend::UpdateDefaultSender.new }

  describe 'test an instance of UpdateDefaultSender' do
    it 'should create an instance of UpdateDefaultSender' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateDefaultSender)
    end
  end
