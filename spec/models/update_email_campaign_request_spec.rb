...
# Unit tests for ClickSend::UpdateEmailCampaignRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateEmailCampaignRequest do
  #let(:instance) { ClickSend::UpdateEmailCampaignRequest.new }

  describe 'test an instance of UpdateEmailCampaignRequest' do
    it 'should create an instance of UpdateEmailCampaignRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateEmailCampaignRequest)
    end
  end
