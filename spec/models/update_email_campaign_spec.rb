...
# Unit tests for ClickSend::UpdateEmailCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateEmailCampaign do
  #let(:instance) { ClickSend::UpdateEmailCampaign.new }

  describe 'test an instance of UpdateEmailCampaign' do
    it 'should create an instance of UpdateEmailCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateEmailCampaign)
    end
  end
