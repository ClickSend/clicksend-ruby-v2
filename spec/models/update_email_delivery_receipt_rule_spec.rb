...
# Unit tests for ClickSend::UpdateEmailDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateEmailDeliveryReceiptRule do
  #let(:instance) { ClickSend::UpdateEmailDeliveryReceiptRule.new }

  describe 'test an instance of UpdateEmailDeliveryReceiptRule' do
    it 'should create an instance of UpdateEmailDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateEmailDeliveryReceiptRule)
    end
  end
