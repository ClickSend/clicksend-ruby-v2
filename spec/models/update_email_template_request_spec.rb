...
# Unit tests for ClickSend::UpdateEmailTemplateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateEmailTemplateRequest do
  #let(:instance) { ClickSend::UpdateEmailTemplateRequest.new }

  describe 'test an instance of UpdateEmailTemplateRequest' do
    it 'should create an instance of UpdateEmailTemplateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateEmailTemplateRequest)
    end
  end
