...
# Unit tests for ClickSend::UpdateEmailTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateEmailTemplate do
  #let(:instance) { ClickSend::UpdateEmailTemplate.new }

  describe 'test an instance of UpdateEmailTemplate' do
    it 'should create an instance of UpdateEmailTemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateEmailTemplate)
    end
  end
