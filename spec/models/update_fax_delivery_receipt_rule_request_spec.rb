...
# Unit tests for ClickSend::UpdateFaxDeliveryReceiptRuleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateFaxDeliveryReceiptRuleRequest do
  #let(:instance) { ClickSend::UpdateFaxDeliveryReceiptRuleRequest.new }

  describe 'test an instance of UpdateFaxDeliveryReceiptRuleRequest' do
    it 'should create an instance of UpdateFaxDeliveryReceiptRuleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateFaxDeliveryReceiptRuleRequest)
    end
  end
