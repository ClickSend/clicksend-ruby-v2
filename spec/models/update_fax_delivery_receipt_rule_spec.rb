...
# Unit tests for ClickSend::UpdateFaxDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateFaxDeliveryReceiptRule do
  #let(:instance) { ClickSend::UpdateFaxDeliveryReceiptRule.new }

  describe 'test an instance of UpdateFaxDeliveryReceiptRule' do
    it 'should create an instance of UpdateFaxDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateFaxDeliveryReceiptRule)
    end
  end
