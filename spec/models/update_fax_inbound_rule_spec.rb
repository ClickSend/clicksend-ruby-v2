...
# Unit tests for ClickSend::UpdateFaxInboundRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateFaxInboundRule do
  #let(:instance) { ClickSend::UpdateFaxInboundRule.new }

  describe 'test an instance of UpdateFaxInboundRule' do
    it 'should create an instance of UpdateFaxInboundRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateFaxInboundRule)
    end
  end
