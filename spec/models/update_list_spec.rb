...
# Unit tests for ClickSend::UpdateList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateList do
  #let(:instance) { ClickSend::UpdateList.new }

  describe 'test an instance of UpdateList' do
    it 'should create an instance of UpdateList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateList)
    end
  end
