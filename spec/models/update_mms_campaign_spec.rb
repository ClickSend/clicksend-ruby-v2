...
# Unit tests for ClickSend::UpdateMmsCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateMmsCampaign do
  #let(:instance) { ClickSend::UpdateMmsCampaign.new }

  describe 'test an instance of UpdateMmsCampaign' do
    it 'should create an instance of UpdateMmsCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateMmsCampaign)
    end
  end
