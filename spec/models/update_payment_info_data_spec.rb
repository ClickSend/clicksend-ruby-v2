...
# Unit tests for ClickSend::UpdatePaymentInfoData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdatePaymentInfoData do
  #let(:instance) { ClickSend::UpdatePaymentInfoData.new }

  describe 'test an instance of UpdatePaymentInfoData' do
    it 'should create an instance of UpdatePaymentInfoData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdatePaymentInfoData)
    end
  end
