...
# Unit tests for ClickSend::UpdatePaymentInfoRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdatePaymentInfoRequest do
  #let(:instance) { ClickSend::UpdatePaymentInfoRequest.new }

  describe 'test an instance of UpdatePaymentInfoRequest' do
    it 'should create an instance of UpdatePaymentInfoRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdatePaymentInfoRequest)
    end
  end
