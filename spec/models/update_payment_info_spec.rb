...
# Unit tests for ClickSend::UpdatePaymentInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdatePaymentInfo do
  #let(:instance) { ClickSend::UpdatePaymentInfo.new }

  describe 'test an instance of UpdatePaymentInfo' do
    it 'should create an instance of UpdatePaymentInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdatePaymentInfo)
    end
  end
