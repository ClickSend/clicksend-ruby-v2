...
# Unit tests for ClickSend::UpdateReturnAddressRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateReturnAddressRequest do
  #let(:instance) { ClickSend::UpdateReturnAddressRequest.new }

  describe 'test an instance of UpdateReturnAddressRequest' do
    it 'should create an instance of UpdateReturnAddressRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateReturnAddressRequest)
    end
  end
