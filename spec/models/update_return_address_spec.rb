...
# Unit tests for ClickSend::UpdateReturnAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateReturnAddress do
  #let(:instance) { ClickSend::UpdateReturnAddress.new }

  describe 'test an instance of UpdateReturnAddress' do
    it 'should create an instance of UpdateReturnAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateReturnAddress)
    end
  end
