...
# Unit tests for ClickSend::UpdateSmsCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateSmsCampaign do
  #let(:instance) { ClickSend::UpdateSmsCampaign.new }

  describe 'test an instance of UpdateSmsCampaign' do
    it 'should create an instance of UpdateSmsCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateSmsCampaign)
    end
  end
