...
# Unit tests for ClickSend::UpdateSmsDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateSmsDeliveryReceiptRule do
  #let(:instance) { ClickSend::UpdateSmsDeliveryReceiptRule.new }

  describe 'test an instance of UpdateSmsDeliveryReceiptRule' do
    it 'should create an instance of UpdateSmsDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateSmsDeliveryReceiptRule)
    end
  end
