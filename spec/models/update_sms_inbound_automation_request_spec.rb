...
# Unit tests for ClickSend::UpdateSmsInboundAutomationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateSmsInboundAutomationRequest do
  #let(:instance) { ClickSend::UpdateSmsInboundAutomationRequest.new }

  describe 'test an instance of UpdateSmsInboundAutomationRequest' do
    it 'should create an instance of UpdateSmsInboundAutomationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateSmsInboundAutomationRequest)
    end
  end
