...
# Unit tests for ClickSend::UpdateSmsInboundAutomation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateSmsInboundAutomation do
  #let(:instance) { ClickSend::UpdateSmsInboundAutomation.new }

  describe 'test an instance of UpdateSmsInboundAutomation' do
    it 'should create an instance of UpdateSmsInboundAutomation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateSmsInboundAutomation)
    end
  end
