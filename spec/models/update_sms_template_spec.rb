...
# Unit tests for ClickSend::UpdateSmsTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateSmsTemplate do
  #let(:instance) { ClickSend::UpdateSmsTemplate.new }

  describe 'test an instance of UpdateSmsTemplate' do
    it 'should create an instance of UpdateSmsTemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateSmsTemplate)
    end
  end
