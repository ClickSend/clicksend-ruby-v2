...
# Unit tests for ClickSend::UpdateStrippedStringRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateStrippedStringRule do
  #let(:instance) { ClickSend::UpdateStrippedStringRule.new }

  describe 'test an instance of UpdateStrippedStringRule' do
    it 'should create an instance of UpdateStrippedStringRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateStrippedStringRule)
    end
  end
