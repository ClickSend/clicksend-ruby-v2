...
# Unit tests for ClickSend::UpdateSubaccountRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateSubaccountRequest do
  #let(:instance) { ClickSend::UpdateSubaccountRequest.new }
  ...
  describe 'test an instance of UpdateSubaccountRequest' do
    it 'should create an instance of UpdateSubaccountRequest' do
      ...
      #expect(instance).to be_instance_of(ClickSend::UpdateSubaccountRequest)
    end
  end
