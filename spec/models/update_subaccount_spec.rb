...
# Unit tests for ClickSend::UpdateSubaccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateSubaccount do
  #let(:instance) { ClickSend::UpdateSubaccount.new }

  describe 'test an instance of UpdateSubaccount' do
    it 'should create an instance of UpdateSubaccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateSubaccount)
    end
  end
