...
# Unit tests for ClickSend::UpdateVoiceDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UpdateVoiceDeliveryReceiptRule do
  #let(:instance) { ClickSend::UpdateVoiceDeliveryReceiptRule.new }

  describe 'test an instance of UpdateVoiceDeliveryReceiptRule' do
    it 'should create an instance of UpdateVoiceDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UpdateVoiceDeliveryReceiptRule)
    end
  end
