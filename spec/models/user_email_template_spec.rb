...
# Unit tests for ClickSend::UserEmailTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::UserEmailTemplate do
  #let(:instance) { ClickSend::UserEmailTemplate.new }

  describe 'test an instance of UserEmailTemplate' do
    it 'should create an instance of UserEmailTemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::UserEmailTemplate)
    end
  end
