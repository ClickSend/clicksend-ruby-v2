...
# Unit tests for ClickSend::VerifyAllowedEmailAddressRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::VerifyAllowedEmailAddressRequest do
  #let(:instance) { ClickSend::VerifyAllowedEmailAddressRequest.new }

  describe 'test an instance of VerifyAllowedEmailAddressRequest' do
    it 'should create an instance of VerifyAllowedEmailAddressRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::VerifyAllowedEmailAddressRequest)
    end
  end
