...
# Unit tests for ClickSend::VerifyAllowedEmailAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::VerifyAllowedEmailAddress do
  #let(:instance) { ClickSend::VerifyAllowedEmailAddress.new }

  describe 'test an instance of VerifyAllowedEmailAddress' do
    it 'should create an instance of VerifyAllowedEmailAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::VerifyAllowedEmailAddress)
    end
  end
