...
# Unit tests for ClickSend::VerifyOwnNumberOtpRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::VerifyOwnNumberOtpRequest do
  #let(:instance) { ClickSend::VerifyOwnNumberOtpRequest.new }

  describe 'test an instance of VerifyOwnNumberOtpRequest' do
    it 'should create an instance of VerifyOwnNumberOtpRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::VerifyOwnNumberOtpRequest)
    end
  end
