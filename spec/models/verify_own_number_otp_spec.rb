...
# Unit tests for ClickSend::VerifyOwnNumberOtp
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::VerifyOwnNumberOtp do
  #let(:instance) { ClickSend::VerifyOwnNumberOtp.new }

  describe 'test an instance of VerifyOwnNumberOtp' do
    it 'should create an instance of VerifyOwnNumberOtp' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::VerifyOwnNumberOtp)
    end
  end
