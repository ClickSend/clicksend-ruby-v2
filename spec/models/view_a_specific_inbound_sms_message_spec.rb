...
# Unit tests for ClickSend::ViewASpecificInboundSmsMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewASpecificInboundSmsMessage do
  #let(:instance) { ClickSend::ViewASpecificInboundSmsMessage.new }

  describe 'test an instance of ViewASpecificInboundSmsMessage' do
    it 'should create an instance of ViewASpecificInboundSmsMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewASpecificInboundSmsMessage)
    end
  end
