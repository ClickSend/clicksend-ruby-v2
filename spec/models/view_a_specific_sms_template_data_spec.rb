...
# Unit tests for ClickSend::ViewASpecificSmsTemplateData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewASpecificSmsTemplateData do
  #let(:instance) { ClickSend::ViewASpecificSmsTemplateData.new }

  describe 'test an instance of ViewASpecificSmsTemplateData' do
    it 'should create an instance of ViewASpecificSmsTemplateData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewASpecificSmsTemplateData)
    end
  end
