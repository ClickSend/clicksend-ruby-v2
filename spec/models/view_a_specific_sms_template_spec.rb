...
# Unit tests for ClickSend::ViewASpecificSmsTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewASpecificSmsTemplate do
  #let(:instance) { ClickSend::ViewASpecificSmsTemplate.new }

  describe 'test an instance of ViewASpecificSmsTemplate' do
    it 'should create an instance of ViewASpecificSmsTemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewASpecificSmsTemplate)
    end
  end
