...
# Unit tests for ClickSend::ViewAccountDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAccountDetails do
  #let(:instance) { ClickSend::ViewAccountDetails.new }

  describe 'test an instance of ViewAccountDetails' do
    it 'should create an instance of ViewAccountDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAccountDetails)
    end
  end
