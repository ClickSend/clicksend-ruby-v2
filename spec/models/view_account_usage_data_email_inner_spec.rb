...
# Unit tests for ClickSend::ViewAccountUsageDataEmailInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAccountUsageDataEmailInner do
  #let(:instance) { ClickSend::ViewAccountUsageDataEmailInner.new }

  describe 'test an instance of ViewAccountUsageDataEmailInner' do
    it 'should create an instance of ViewAccountUsageDataEmailInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAccountUsageDataEmailInner)
    end
  end
