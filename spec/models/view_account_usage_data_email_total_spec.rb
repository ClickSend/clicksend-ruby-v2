...
# Unit tests for ClickSend::ViewAccountUsageDataEmailTotal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAccountUsageDataEmailTotal do
  #let(:instance) { ClickSend::ViewAccountUsageDataEmailTotal.new }

  describe 'test an instance of ViewAccountUsageDataEmailTotal' do
    it 'should create an instance of ViewAccountUsageDataEmailTotal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAccountUsageDataEmailTotal)
    end
  end
