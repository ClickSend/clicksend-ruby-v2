...
# Unit tests for ClickSend::ViewAccountUsageDataMmsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAccountUsageDataMmsInner do
  #let(:instance) { ClickSend::ViewAccountUsageDataMmsInner.new }

  describe 'test an instance of ViewAccountUsageDataMmsInner' do
    it 'should create an instance of ViewAccountUsageDataMmsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAccountUsageDataMmsInner)
    end
  end
