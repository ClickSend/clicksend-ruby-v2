...
# Unit tests for ClickSend::ViewAccountUsageDataSmsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAccountUsageDataSmsInner do
  #let(:instance) { ClickSend::ViewAccountUsageDataSmsInner.new }

  describe 'test an instance of ViewAccountUsageDataSmsInner' do
    it 'should create an instance of ViewAccountUsageDataSmsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAccountUsageDataSmsInner)
    end
  end
