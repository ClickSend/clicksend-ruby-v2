...
# Unit tests for ClickSend::ViewAccountUsageDataSmsTotal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAccountUsageDataSmsTotal do
  #let(:instance) { ClickSend::ViewAccountUsageDataSmsTotal.new }

  describe 'test an instance of ViewAccountUsageDataSmsTotal' do
    it 'should create an instance of ViewAccountUsageDataSmsTotal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAccountUsageDataSmsTotal)
    end
  end
