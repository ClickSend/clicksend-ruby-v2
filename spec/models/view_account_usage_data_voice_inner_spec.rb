...
# Unit tests for ClickSend::ViewAccountUsageDataVoiceInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAccountUsageDataVoiceInner do
  #let(:instance) { ClickSend::ViewAccountUsageDataVoiceInner.new }

  describe 'test an instance of ViewAccountUsageDataVoiceInner' do
    it 'should create an instance of ViewAccountUsageDataVoiceInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAccountUsageDataVoiceInner)
    end
  end
