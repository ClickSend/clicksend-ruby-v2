...
# Unit tests for ClickSend::ViewAccountUsage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAccountUsage do
  #let(:instance) { ClickSend::ViewAccountUsage.new }

  describe 'test an instance of ViewAccountUsage' do
    it 'should create an instance of ViewAccountUsage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAccountUsage)
    end
  end
