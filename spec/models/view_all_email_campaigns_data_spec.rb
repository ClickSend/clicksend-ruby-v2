...
# Unit tests for ClickSend::ViewAllEmailCampaignsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAllEmailCampaignsData do
  #let(:instance) { ClickSend::ViewAllEmailCampaignsData.new }

  describe 'test an instance of ViewAllEmailCampaignsData' do
    it 'should create an instance of ViewAllEmailCampaignsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAllEmailCampaignsData)
    end
  end
