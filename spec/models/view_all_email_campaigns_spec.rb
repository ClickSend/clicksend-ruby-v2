...
# Unit tests for ClickSend::ViewAllEmailCampaigns
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAllEmailCampaigns do
  #let(:instance) { ClickSend::ViewAllEmailCampaigns.new }

  describe 'test an instance of ViewAllEmailCampaigns' do
    it 'should create an instance of ViewAllEmailCampaigns' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAllEmailCampaigns)
    end
  end
