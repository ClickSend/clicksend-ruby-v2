...
# Unit tests for ClickSend::ViewAllMmsCampaignsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAllMmsCampaignsData do
  #let(:instance) { ClickSend::ViewAllMmsCampaignsData.new }

  describe 'test an instance of ViewAllMmsCampaignsData' do
    it 'should create an instance of ViewAllMmsCampaignsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAllMmsCampaignsData)
    end
  end
