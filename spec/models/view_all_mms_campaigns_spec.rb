...
# Unit tests for ClickSend::ViewAllMmsCampaigns
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAllMmsCampaigns do
  #let(:instance) { ClickSend::ViewAllMmsCampaigns.new }

  describe 'test an instance of ViewAllMmsCampaigns' do
    it 'should create an instance of ViewAllMmsCampaigns' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAllMmsCampaigns)
    end
  end
