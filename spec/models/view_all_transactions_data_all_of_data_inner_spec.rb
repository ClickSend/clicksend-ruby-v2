...
# Unit tests for ClickSend::ViewAllTransactionsDataAllOfDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAllTransactionsDataAllOfDataInner do
  #let(:instance) { ClickSend::ViewAllTransactionsDataAllOfDataInner.new }

  describe 'test an instance of ViewAllTransactionsDataAllOfDataInner' do
    it 'should create an instance of ViewAllTransactionsDataAllOfDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAllTransactionsDataAllOfDataInner)
    end
  end
