...
# Unit tests for ClickSend::ViewAllTransactionsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAllTransactionsData do
  #let(:instance) { ClickSend::ViewAllTransactionsData.new }

  describe 'test an instance of ViewAllTransactionsData' do
    it 'should create an instance of ViewAllTransactionsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAllTransactionsData)
    end
  end
