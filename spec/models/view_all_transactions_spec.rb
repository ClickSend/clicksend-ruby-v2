...
# Unit tests for ClickSend::ViewAllTransactions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAllTransactions do
  #let(:instance) { ClickSend::ViewAllTransactions.new }

  describe 'test an instance of ViewAllTransactions' do
    it 'should create an instance of ViewAllTransactions' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAllTransactions)
    end
  end
