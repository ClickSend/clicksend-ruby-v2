...
# Unit tests for ClickSend::ViewAllowedEmailAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAllowedEmailAddress do
  #let(:instance) { ClickSend::ViewAllowedEmailAddress.new }

  describe 'test an instance of ViewAllowedEmailAddress' do
    it 'should create an instance of ViewAllowedEmailAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAllowedEmailAddress)
    end
  end
