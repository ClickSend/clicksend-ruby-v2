...
# Unit tests for ClickSend::ViewAllowedEmailAddressesData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAllowedEmailAddressesData do
  #let(:instance) { ClickSend::ViewAllowedEmailAddressesData.new }

  describe 'test an instance of ViewAllowedEmailAddressesData' do
    it 'should create an instance of ViewAllowedEmailAddressesData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAllowedEmailAddressesData)
    end
  end
