...
# Unit tests for ClickSend::ViewAllowedEmailAddresses
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAllowedEmailAddresses do
  #let(:instance) { ClickSend::ViewAllowedEmailAddresses.new }

  describe 'test an instance of ViewAllowedEmailAddresses' do
    it 'should create an instance of ViewAllowedEmailAddresses' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAllowedEmailAddresses)
    end
  end
