...
# Unit tests for ClickSend::ViewAllowedEmailsDataAllOfDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAllowedEmailsDataAllOfDataInner do
  #let(:instance) { ClickSend::ViewAllowedEmailsDataAllOfDataInner.new }

  describe 'test an instance of ViewAllowedEmailsDataAllOfDataInner' do
    it 'should create an instance of ViewAllowedEmailsDataAllOfDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAllowedEmailsDataAllOfDataInner)
    end
  end
  ...
  describe 'test attribute "from_fax"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "_subaccount_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
