...
# Unit tests for ClickSend::ViewAllowedEmailsDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAllowedEmailsDataInner do
  #let(:instance) { ClickSend::ViewAllowedEmailsDataInner.new }

  describe 'test an instance of ViewAllowedEmailsDataInner' do
    it 'should create an instance of ViewAllowedEmailsDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAllowedEmailsDataInner)
    end
  end
