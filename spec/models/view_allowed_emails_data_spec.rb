...
# Unit tests for ClickSend::ViewAllowedEmailsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAllowedEmailsData do
  #let(:instance) { ClickSend::ViewAllowedEmailsData.new }

  describe 'test an instance of ViewAllowedEmailsData' do
    it 'should create an instance of ViewAllowedEmailsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAllowedEmailsData)
    end
  end
