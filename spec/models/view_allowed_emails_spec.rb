...
# Unit tests for ClickSend::ViewAllowedEmails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAllowedEmails do
  #let(:instance) { ClickSend::ViewAllowedEmails.new }

  describe 'test an instance of ViewAllowedEmails' do
    it 'should create an instance of ViewAllowedEmails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAllowedEmails)
    end
  end
