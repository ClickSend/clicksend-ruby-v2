...
# Unit tests for ClickSend::ViewAvailableNumbersDataAllOfDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAvailableNumbersDataAllOfDataInner do
  #let(:instance) { ClickSend::ViewAvailableNumbersDataAllOfDataInner.new }

  describe 'test an instance of ViewAvailableNumbersDataAllOfDataInner' do
    it 'should create an instance of ViewAvailableNumbersDataAllOfDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAvailableNumbersDataAllOfDataInner)
    end
  end
  ...
  describe 'test attribute "price_setup"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "price_monthly"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "price_total"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "address_requirement"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
