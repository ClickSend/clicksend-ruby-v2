...
# Unit tests for ClickSend::ViewAvailableNumbersDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAvailableNumbersDataInner do
  #let(:instance) { ClickSend::ViewAvailableNumbersDataInner.new }

  describe 'test an instance of ViewAvailableNumbersDataInner' do
    it 'should create an instance of ViewAvailableNumbersDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAvailableNumbersDataInner)
    end
  end
