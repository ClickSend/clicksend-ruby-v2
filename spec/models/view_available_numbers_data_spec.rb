...
# Unit tests for ClickSend::ViewAvailableNumbersData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAvailableNumbersData do
  #let(:instance) { ClickSend::ViewAvailableNumbersData.new }

  describe 'test an instance of ViewAvailableNumbersData' do
    it 'should create an instance of ViewAvailableNumbersData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAvailableNumbersData)
    end
  end
