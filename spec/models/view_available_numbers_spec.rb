...
# Unit tests for ClickSend::ViewAvailableNumbers
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewAvailableNumbers do
  #let(:instance) { ClickSend::ViewAvailableNumbers.new }

  describe 'test an instance of ViewAvailableNumbers' do
    it 'should create an instance of ViewAvailableNumbers' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewAvailableNumbers)
    end
  end
