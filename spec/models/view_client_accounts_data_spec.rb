...
# Unit tests for ClickSend::ViewClientAccountsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewClientAccountsData do
  #let(:instance) { ClickSend::ViewClientAccountsData.new }

  describe 'test an instance of ViewClientAccountsData' do
    it 'should create an instance of ViewClientAccountsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewClientAccountsData)
    end
  end
