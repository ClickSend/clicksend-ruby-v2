...
# Unit tests for ClickSend::ViewClientAccounts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewClientAccounts do
  #let(:instance) { ClickSend::ViewClientAccounts.new }

  describe 'test an instance of ViewClientAccounts' do
    it 'should create an instance of ViewClientAccounts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewClientAccounts)
    end
  end
