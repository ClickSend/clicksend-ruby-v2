...
# Unit tests for ClickSend::ViewCountries
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewCountries do
  #let(:instance) { ClickSend::ViewCountries.new }

  describe 'test an instance of ViewCountries' do
    it 'should create an instance of ViewCountries' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewCountries)
    end
  end
