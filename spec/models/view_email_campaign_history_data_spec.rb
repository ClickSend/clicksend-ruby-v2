...
# Unit tests for ClickSend::ViewEmailCampaignHistoryData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewEmailCampaignHistoryData do
  #let(:instance) { ClickSend::ViewEmailCampaignHistoryData.new }

  describe 'test an instance of ViewEmailCampaignHistoryData' do
    it 'should create an instance of ViewEmailCampaignHistoryData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewEmailCampaignHistoryData)
    end
  end
