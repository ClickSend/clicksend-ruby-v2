...
# Unit tests for ClickSend::ViewEmailCampaignHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewEmailCampaignHistory do
  #let(:instance) { ClickSend::ViewEmailCampaignHistory.new }

  describe 'test an instance of ViewEmailCampaignHistory' do
    it 'should create an instance of ViewEmailCampaignHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewEmailCampaignHistory)
    end
  end
