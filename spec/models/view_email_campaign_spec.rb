...
# Unit tests for ClickSend::ViewEmailCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewEmailCampaign do
  #let(:instance) { ClickSend::ViewEmailCampaign.new }

  describe 'test an instance of ViewEmailCampaign' do
    it 'should create an instance of ViewEmailCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewEmailCampaign)
    end
  end
