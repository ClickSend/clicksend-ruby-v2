...
# Unit tests for ClickSend::ViewEmailDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewEmailDeliveryReceiptRule do
  #let(:instance) { ClickSend::ViewEmailDeliveryReceiptRule.new }

  describe 'test an instance of ViewEmailDeliveryReceiptRule' do
    it 'should create an instance of ViewEmailDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewEmailDeliveryReceiptRule)
    end
  end
