...
# Unit tests for ClickSend::ViewEmailDeliveryReceiptRulesData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewEmailDeliveryReceiptRulesData do
  #let(:instance) { ClickSend::ViewEmailDeliveryReceiptRulesData.new }

  describe 'test an instance of ViewEmailDeliveryReceiptRulesData' do
    it 'should create an instance of ViewEmailDeliveryReceiptRulesData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewEmailDeliveryReceiptRulesData)
    end
  end
