...
# Unit tests for ClickSend::ViewEmailDeliveryReceiptRules
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewEmailDeliveryReceiptRules do
  #let(:instance) { ClickSend::ViewEmailDeliveryReceiptRules.new }

  describe 'test an instance of ViewEmailDeliveryReceiptRules' do
    it 'should create an instance of ViewEmailDeliveryReceiptRules' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewEmailDeliveryReceiptRules)
    end
  end
