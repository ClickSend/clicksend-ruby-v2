...
# Unit tests for ClickSend::ViewEmailHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewEmailHistory do
  #let(:instance) { ClickSend::ViewEmailHistory.new }

  describe 'test an instance of ViewEmailHistory' do
    it 'should create an instance of ViewEmailHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewEmailHistory)
    end
  end
