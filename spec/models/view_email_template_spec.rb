...
# Unit tests for ClickSend::ViewEmailTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewEmailTemplate do
  #let(:instance) { ClickSend::ViewEmailTemplate.new }

  describe 'test an instance of ViewEmailTemplate' do
    it 'should create an instance of ViewEmailTemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewEmailTemplate)
    end
  end
