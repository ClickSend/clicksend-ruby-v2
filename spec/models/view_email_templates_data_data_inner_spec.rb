...
# Unit tests for ClickSend::ViewEmailTemplatesDataDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewEmailTemplatesDataDataInner do
  #let(:instance) { ClickSend::ViewEmailTemplatesDataDataInner.new }

  describe 'test an instance of ViewEmailTemplatesDataDataInner' do
    it 'should create an instance of ViewEmailTemplatesDataDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewEmailTemplatesDataDataInner)
    end
  end
