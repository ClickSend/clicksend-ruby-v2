...
# Unit tests for ClickSend::ViewEmailTemplatesData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewEmailTemplatesData do
  #let(:instance) { ClickSend::ViewEmailTemplatesData.new }

  describe 'test an instance of ViewEmailTemplatesData' do
    it 'should create an instance of ViewEmailTemplatesData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewEmailTemplatesData)
    end
  end
