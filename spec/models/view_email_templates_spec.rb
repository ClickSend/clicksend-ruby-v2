...
# Unit tests for ClickSend::ViewEmailTemplates
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewEmailTemplates do
  #let(:instance) { ClickSend::ViewEmailTemplates.new }

  describe 'test an instance of ViewEmailTemplates' do
    it 'should create an instance of ViewEmailTemplates' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewEmailTemplates)
    end
  end
