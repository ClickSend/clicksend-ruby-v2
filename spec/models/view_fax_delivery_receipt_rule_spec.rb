...
# Unit tests for ClickSend::ViewFaxDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewFaxDeliveryReceiptRule do
  #let(:instance) { ClickSend::ViewFaxDeliveryReceiptRule.new }

  describe 'test an instance of ViewFaxDeliveryReceiptRule' do
    it 'should create an instance of ViewFaxDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewFaxDeliveryReceiptRule)
    end
  end
