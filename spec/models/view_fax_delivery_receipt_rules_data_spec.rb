...
# Unit tests for ClickSend::ViewFaxDeliveryReceiptRulesData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewFaxDeliveryReceiptRulesData do
  #let(:instance) { ClickSend::ViewFaxDeliveryReceiptRulesData.new }

  describe 'test an instance of ViewFaxDeliveryReceiptRulesData' do
    it 'should create an instance of ViewFaxDeliveryReceiptRulesData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewFaxDeliveryReceiptRulesData)
    end
  end
