...
# Unit tests for ClickSend::ViewFaxDeliveryReceiptRules
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewFaxDeliveryReceiptRules do
  #let(:instance) { ClickSend::ViewFaxDeliveryReceiptRules.new }

  describe 'test an instance of ViewFaxDeliveryReceiptRules' do
    it 'should create an instance of ViewFaxDeliveryReceiptRules' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewFaxDeliveryReceiptRules)
    end
  end
