...
# Unit tests for ClickSend::ViewFaxHistoryData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewFaxHistoryData do
  #let(:instance) { ClickSend::ViewFaxHistoryData.new }

  describe 'test an instance of ViewFaxHistoryData' do
    it 'should create an instance of ViewFaxHistoryData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewFaxHistoryData)
    end
  end
