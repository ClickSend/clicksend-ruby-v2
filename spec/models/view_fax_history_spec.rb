...
# Unit tests for ClickSend::ViewFaxHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewFaxHistory do
  #let(:instance) { ClickSend::ViewFaxHistory.new }

  describe 'test an instance of ViewFaxHistory' do
    it 'should create an instance of ViewFaxHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewFaxHistory)
    end
  end
