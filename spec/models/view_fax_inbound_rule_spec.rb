...
# Unit tests for ClickSend::ViewFaxInboundRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewFaxInboundRule do
  #let(:instance) { ClickSend::ViewFaxInboundRule.new }

  describe 'test an instance of ViewFaxInboundRule' do
    it 'should create an instance of ViewFaxInboundRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewFaxInboundRule)
    end
  end
