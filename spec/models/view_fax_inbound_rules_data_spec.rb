...
# Unit tests for ClickSend::ViewFaxInboundRulesData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewFaxInboundRulesData do
  #let(:instance) { ClickSend::ViewFaxInboundRulesData.new }

  describe 'test an instance of ViewFaxInboundRulesData' do
    it 'should create an instance of ViewFaxInboundRulesData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewFaxInboundRulesData)
    end
  end
