...
# Unit tests for ClickSend::ViewFaxInboundRules
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewFaxInboundRules do
  #let(:instance) { ClickSend::ViewFaxInboundRules.new }

  describe 'test an instance of ViewFaxInboundRules' do
    it 'should create an instance of ViewFaxInboundRules' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewFaxInboundRules)
    end
  end
