...
# Unit tests for ClickSend::ViewFaxReceiptsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewFaxReceiptsData do
  #let(:instance) { ClickSend::ViewFaxReceiptsData.new }

  describe 'test an instance of ViewFaxReceiptsData' do
    it 'should create an instance of ViewFaxReceiptsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewFaxReceiptsData)
    end
  end
