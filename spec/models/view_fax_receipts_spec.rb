...
# Unit tests for ClickSend::ViewFaxReceipts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewFaxReceipts do
  #let(:instance) { ClickSend::ViewFaxReceipts.new }

  describe 'test an instance of ViewFaxReceipts' do
    it 'should create an instance of ViewFaxReceipts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewFaxReceipts)
    end
  end
