...
# Unit tests for ClickSend::ViewInboundSmsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewInboundSmsData do
  #let(:instance) { ClickSend::ViewInboundSmsData.new }

  describe 'test an instance of ViewInboundSmsData' do
    it 'should create an instance of ViewInboundSmsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewInboundSmsData)
    end
  end
