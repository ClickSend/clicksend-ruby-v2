...
# Unit tests for ClickSend::ViewInboundSms
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewInboundSms do
  #let(:instance) { ClickSend::ViewInboundSms.new }

  describe 'test an instance of ViewInboundSms' do
    it 'should create an instance of ViewInboundSms' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewInboundSms)
    end
  end
