...
# Unit tests for ClickSend::ViewLetterHistoryData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewLetterHistoryData do
  #let(:instance) { ClickSend::ViewLetterHistoryData.new }

  describe 'test an instance of ViewLetterHistoryData' do
    it 'should create an instance of ViewLetterHistoryData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewLetterHistoryData)
    end
  end
