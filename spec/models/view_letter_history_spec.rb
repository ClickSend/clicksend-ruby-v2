...
# Unit tests for ClickSend::ViewLetterHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewLetterHistory do
  #let(:instance) { ClickSend::ViewLetterHistory.new }

  describe 'test an instance of ViewLetterHistory' do
    it 'should create an instance of ViewLetterHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewLetterHistory)
    end
  end
