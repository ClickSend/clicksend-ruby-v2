...
# Unit tests for ClickSend::ViewListContactsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewListContactsData do
  #let(:instance) { ClickSend::ViewListContactsData.new }

  describe 'test an instance of ViewListContactsData' do
    it 'should create an instance of ViewListContactsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewListContactsData)
    end
  end
