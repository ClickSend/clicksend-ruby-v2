...
# Unit tests for ClickSend::ViewListContacts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewListContacts do
  #let(:instance) { ClickSend::ViewListContacts.new }

  describe 'test an instance of ViewListContacts' do
    it 'should create an instance of ViewListContacts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewListContacts)
    end
  end
