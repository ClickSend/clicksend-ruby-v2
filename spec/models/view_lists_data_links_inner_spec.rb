...
# Unit tests for ClickSend::ViewListsDataLinksInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewListsDataLinksInner do
  #let(:instance) { ClickSend::ViewListsDataLinksInner.new }

  describe 'test an instance of ViewListsDataLinksInner' do
    it 'should create an instance of ViewListsDataLinksInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewListsDataLinksInner)
    end
  end
