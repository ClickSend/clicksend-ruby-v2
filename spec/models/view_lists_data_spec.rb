...
# Unit tests for ClickSend::ViewListsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewListsData do
  #let(:instance) { ClickSend::ViewListsData.new }

  describe 'test an instance of ViewListsData' do
    it 'should create an instance of ViewListsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewListsData)
    end
  end
