...
# Unit tests for ClickSend::ViewLists
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewLists do
  #let(:instance) { ClickSend::ViewLists.new }

  describe 'test an instance of ViewLists' do
    it 'should create an instance of ViewLists' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewLists)
    end
  end
