...
# Unit tests for ClickSend::ViewMasterEmailTemplate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewMasterEmailTemplate do
  #let(:instance) { ClickSend::ViewMasterEmailTemplate.new }

  describe 'test an instance of ViewMasterEmailTemplate' do
    it 'should create an instance of ViewMasterEmailTemplate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewMasterEmailTemplate)
    end
  end
