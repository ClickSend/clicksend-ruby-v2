...
# Unit tests for ClickSend::ViewMasterEmailTemplates
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewMasterEmailTemplates do
  #let(:instance) { ClickSend::ViewMasterEmailTemplates.new }

  describe 'test an instance of ViewMasterEmailTemplates' do
    it 'should create an instance of ViewMasterEmailTemplates' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewMasterEmailTemplates)
    end
  end
