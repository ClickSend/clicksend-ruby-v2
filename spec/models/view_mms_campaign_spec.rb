...
# Unit tests for ClickSend::ViewMmsCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewMmsCampaign do
  #let(:instance) { ClickSend::ViewMmsCampaign.new }

  describe 'test an instance of ViewMmsCampaign' do
    it 'should create an instance of ViewMmsCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewMmsCampaign)
    end
  end
