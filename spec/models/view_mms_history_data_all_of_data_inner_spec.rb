...
# Unit tests for ClickSend::ViewMmsHistoryDataAllOfDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewMmsHistoryDataAllOfDataInner do
  #let(:instance) { ClickSend::ViewMmsHistoryDataAllOfDataInner.new }

  describe 'test an instance of ViewMmsHistoryDataAllOfDataInner' do
    it 'should create an instance of ViewMmsHistoryDataAllOfDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewMmsHistoryDataAllOfDataInner)
    end
  end
  ...
  describe 'test attribute "_media_file_url"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "message_parts"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
