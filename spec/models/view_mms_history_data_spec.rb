...
# Unit tests for ClickSend::ViewMmsHistoryData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewMmsHistoryData do
  #let(:instance) { ClickSend::ViewMmsHistoryData.new }

  describe 'test an instance of ViewMmsHistoryData' do
    it 'should create an instance of ViewMmsHistoryData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewMmsHistoryData)
    end
  end
