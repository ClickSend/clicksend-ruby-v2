...
# Unit tests for ClickSend::ViewMmsHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewMmsHistory do
  #let(:instance) { ClickSend::ViewMmsHistory.new }

  describe 'test an instance of ViewMmsHistory' do
    it 'should create an instance of ViewMmsHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewMmsHistory)
    end
  end
