...
# Unit tests for ClickSend::ViewPostcardHistoryData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewPostcardHistoryData do
  #let(:instance) { ClickSend::ViewPostcardHistoryData.new }

  describe 'test an instance of ViewPostcardHistoryData' do
    it 'should create an instance of ViewPostcardHistoryData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewPostcardHistoryData)
    end
  end
