...
# Unit tests for ClickSend::ViewPostcardHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewPostcardHistory do
  #let(:instance) { ClickSend::ViewPostcardHistory.new }

  describe 'test an instance of ViewPostcardHistory' do
    it 'should create an instance of ViewPostcardHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewPostcardHistory)
    end
  end
