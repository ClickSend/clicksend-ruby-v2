...
# Unit tests for ClickSend::ViewRechargePackagesData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewRechargePackagesData do
  #let(:instance) { ClickSend::ViewRechargePackagesData.new }

  describe 'test an instance of ViewRechargePackagesData' do
    it 'should create an instance of ViewRechargePackagesData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewRechargePackagesData)
    end
  end
