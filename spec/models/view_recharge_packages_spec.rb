...
# Unit tests for ClickSend::ViewRechargePackages
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewRechargePackages do
  #let(:instance) { ClickSend::ViewRechargePackages.new }

  describe 'test an instance of ViewRechargePackages' do
    it 'should create an instance of ViewRechargePackages' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewRechargePackages)
    end
  end
