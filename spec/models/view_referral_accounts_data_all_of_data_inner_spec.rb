...
# Unit tests for ClickSend::ViewReferralAccountsDataAllOfDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewReferralAccountsDataAllOfDataInner do
  #let(:instance) { ClickSend::ViewReferralAccountsDataAllOfDataInner.new }

  describe 'test an instance of ViewReferralAccountsDataAllOfDataInner' do
    it 'should create an instance of ViewReferralAccountsDataAllOfDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewReferralAccountsDataAllOfDataInner)
    end
  end

  describe 'test attribute "referral_rule_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "refered_user_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "date_referred"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "percentage_referral"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
