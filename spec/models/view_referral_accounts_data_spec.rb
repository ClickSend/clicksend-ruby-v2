...
# Unit tests for ClickSend::ViewReferralAccountsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewReferralAccountsData do
  #let(:instance) { ClickSend::ViewReferralAccountsData.new }

  describe 'test an instance of ViewReferralAccountsData' do
    it 'should create an instance of ViewReferralAccountsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewReferralAccountsData)
    end
  end
