...
# Unit tests for ClickSend::ViewReferralAccounts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewReferralAccounts do
  #let(:instance) { ClickSend::ViewReferralAccounts.new }

  describe 'test an instance of ViewReferralAccounts' do
    it 'should create an instance of ViewReferralAccounts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewReferralAccounts)
    end
  end
