...
# Unit tests for ClickSend::ViewSmsCampaignsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsCampaignsData do
  #let(:instance) { ClickSend::ViewSmsCampaignsData.new }

  describe 'test an instance of ViewSmsCampaignsData' do
    it 'should create an instance of ViewSmsCampaignsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsCampaignsData)
    end
  end
