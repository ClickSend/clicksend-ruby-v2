...
# Unit tests for ClickSend::ViewSmsCampaigns
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsCampaigns do
  #let(:instance) { ClickSend::ViewSmsCampaigns.new }

  describe 'test an instance of ViewSmsCampaigns' do
    it 'should create an instance of ViewSmsCampaigns' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsCampaigns)
    end
  end
