...
# Unit tests for ClickSend::ViewSmsDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsDeliveryReceiptRule do
  #let(:instance) { ClickSend::ViewSmsDeliveryReceiptRule.new }

  describe 'test an instance of ViewSmsDeliveryReceiptRule' do
    it 'should create an instance of ViewSmsDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsDeliveryReceiptRule)
    end
  end
