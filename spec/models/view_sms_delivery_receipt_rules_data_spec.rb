...
# Unit tests for ClickSend::ViewSmsDeliveryReceiptRulesData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsDeliveryReceiptRulesData do
  #let(:instance) { ClickSend::ViewSmsDeliveryReceiptRulesData.new }

  describe 'test an instance of ViewSmsDeliveryReceiptRulesData' do
    it 'should create an instance of ViewSmsDeliveryReceiptRulesData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsDeliveryReceiptRulesData)
    end
  end
