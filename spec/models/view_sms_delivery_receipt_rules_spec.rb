...
# Unit tests for ClickSend::ViewSmsDeliveryReceiptRules
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsDeliveryReceiptRules do
  #let(:instance) { ClickSend::ViewSmsDeliveryReceiptRules.new }

  describe 'test an instance of ViewSmsDeliveryReceiptRules' do
    it 'should create an instance of ViewSmsDeliveryReceiptRules' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsDeliveryReceiptRules)
    end
  end
