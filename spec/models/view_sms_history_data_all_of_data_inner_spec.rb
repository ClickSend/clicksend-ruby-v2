...
# Unit tests for ClickSend::ViewSmsHistoryDataAllOfDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsHistoryDataAllOfDataInner do
  #let(:instance) { ClickSend::ViewSmsHistoryDataAllOfDataInner.new }

  describe 'test an instance of ViewSmsHistoryDataAllOfDataInner' do
    it 'should create an instance of ViewSmsHistoryDataAllOfDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsHistoryDataAllOfDataInner)
    end
  end
