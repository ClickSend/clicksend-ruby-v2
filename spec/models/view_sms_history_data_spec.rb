...
# Unit tests for ClickSend::ViewSmsHistoryData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsHistoryData do
  #let(:instance) { ClickSend::ViewSmsHistoryData.new }

  describe 'test an instance of ViewSmsHistoryData' do
    it 'should create an instance of ViewSmsHistoryData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsHistoryData)
    end
  end
