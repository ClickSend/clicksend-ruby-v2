...
# Unit tests for ClickSend::ViewSmsHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsHistory do
  #let(:instance) { ClickSend::ViewSmsHistory.new }

  describe 'test an instance of ViewSmsHistory' do
    it 'should create an instance of ViewSmsHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsHistory)
    end
  end
