...
# Unit tests for ClickSend::ViewSmsInboundAutomation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsInboundAutomation do
  #let(:instance) { ClickSend::ViewSmsInboundAutomation.new }

  describe 'test an instance of ViewSmsInboundAutomation' do
    it 'should create an instance of ViewSmsInboundAutomation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsInboundAutomation)
    end
  end
