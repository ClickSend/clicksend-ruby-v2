...
# Unit tests for ClickSend::ViewSmsInboundAutomationsDataAllOfLinksInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsInboundAutomationsDataAllOfLinksInner do
  #let(:instance) { ClickSend::ViewSmsInboundAutomationsDataAllOfLinksInner.new }

  describe 'test an instance of ViewSmsInboundAutomationsDataAllOfLinksInner' do
    it 'should create an instance of ViewSmsInboundAutomationsDataAllOfLinksInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsInboundAutomationsDataAllOfLinksInner)
    end
  end
