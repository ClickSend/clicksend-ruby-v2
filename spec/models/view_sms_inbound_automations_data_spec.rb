...
# Unit tests for ClickSend::ViewSmsInboundAutomationsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsInboundAutomationsData do
  #let(:instance) { ClickSend::ViewSmsInboundAutomationsData.new }

  describe 'test an instance of ViewSmsInboundAutomationsData' do
    it 'should create an instance of ViewSmsInboundAutomationsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsInboundAutomationsData)
    end
  end
