...
# Unit tests for ClickSend::ViewSmsInboundAutomations
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsInboundAutomations do
  #let(:instance) { ClickSend::ViewSmsInboundAutomations.new }

  describe 'test an instance of ViewSmsInboundAutomations' do
    it 'should create an instance of ViewSmsInboundAutomations' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsInboundAutomations)
    end
  end
