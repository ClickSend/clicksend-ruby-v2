...
# Unit tests for ClickSend::ViewSmsReceiptsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsReceiptsData do
  #let(:instance) { ClickSend::ViewSmsReceiptsData.new }

  describe 'test an instance of ViewSmsReceiptsData' do
    it 'should create an instance of ViewSmsReceiptsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsReceiptsData)
    end
  end
