...
# Unit tests for ClickSend::ViewSmsReceipts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsReceipts do
  #let(:instance) { ClickSend::ViewSmsReceipts.new }

  describe 'test an instance of ViewSmsReceipts' do
    it 'should create an instance of ViewSmsReceipts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsReceipts)
    end
  end
