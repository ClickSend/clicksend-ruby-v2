...
# Unit tests for ClickSend::ViewSmsStatisticsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsStatisticsData do
  #let(:instance) { ClickSend::ViewSmsStatisticsData.new }

  describe 'test an instance of ViewSmsStatisticsData' do
    it 'should create an instance of ViewSmsStatisticsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsStatisticsData)
    end
  end
