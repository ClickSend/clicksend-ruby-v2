...
# Unit tests for ClickSend::ViewSmsStatisticsDataStatInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsStatisticsDataStatInner do
  #let(:instance) { ClickSend::ViewSmsStatisticsDataStatInner.new }

  describe 'test an instance of ViewSmsStatisticsDataStatInner' do
    it 'should create an instance of ViewSmsStatisticsDataStatInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsStatisticsDataStatInner)
    end
  end
