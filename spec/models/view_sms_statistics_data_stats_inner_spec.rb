...
# Unit tests for ClickSend::ViewSmsStatisticsDataStatsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsStatisticsDataStatsInner do
  #let(:instance) { ClickSend::ViewSmsStatisticsDataStatsInner.new }

  describe 'test an instance of ViewSmsStatisticsDataStatsInner' do
    it 'should create an instance of ViewSmsStatisticsDataStatsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsStatisticsDataStatsInner)
    end
  end
