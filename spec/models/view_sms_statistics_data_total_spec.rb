...
# Unit tests for ClickSend::ViewSmsStatisticsDataTotal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsStatisticsDataTotal do
  #let(:instance) { ClickSend::ViewSmsStatisticsDataTotal.new }

  describe 'test an instance of ViewSmsStatisticsDataTotal' do
    it 'should create an instance of ViewSmsStatisticsDataTotal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsStatisticsDataTotal)
    end
  end
