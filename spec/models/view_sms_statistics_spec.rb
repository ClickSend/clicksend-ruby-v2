...
# Unit tests for ClickSend::ViewSmsStatistics
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsStatistics do
  #let(:instance) { ClickSend::ViewSmsStatistics.new }

  describe 'test an instance of ViewSmsStatistics' do
    it 'should create an instance of ViewSmsStatistics' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsStatistics)
    end
  end
