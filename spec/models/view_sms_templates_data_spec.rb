...
# Unit tests for ClickSend::ViewSmsTemplatesData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsTemplatesData do
  #let(:instance) { ClickSend::ViewSmsTemplatesData.new }

  describe 'test an instance of ViewSmsTemplatesData' do
    it 'should create an instance of ViewSmsTemplatesData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsTemplatesData)
    end
  end
