...
# Unit tests for ClickSend::ViewSmsTemplates
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSmsTemplates do
  #let(:instance) { ClickSend::ViewSmsTemplates.new }

  describe 'test an instance of ViewSmsTemplates' do
    it 'should create an instance of ViewSmsTemplates' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSmsTemplates)
    end
  end
