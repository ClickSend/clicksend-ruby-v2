...
# Unit tests for ClickSend::ViewSpecificClientAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSpecificClientAccount do
  #let(:instance) { ClickSend::ViewSpecificClientAccount.new }

  describe 'test an instance of ViewSpecificClientAccount' do
    it 'should create an instance of ViewSpecificClientAccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSpecificClientAccount)
    end
  end
