...
# Unit tests for ClickSend::ViewSpecificFaxReceipt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSpecificFaxReceipt do
  #let(:instance) { ClickSend::ViewSpecificFaxReceipt.new }

  describe 'test an instance of ViewSpecificFaxReceipt' do
    it 'should create an instance of ViewSpecificFaxReceipt' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSpecificFaxReceipt)
    end
  end
