...
# Unit tests for ClickSend::ViewSpecificList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSpecificList do
  #let(:instance) { ClickSend::ViewSpecificList.new }

  describe 'test an instance of ViewSpecificList' do
    it 'should create an instance of ViewSpecificList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSpecificList)
    end
  end
