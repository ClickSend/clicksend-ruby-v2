...
# Unit tests for ClickSend::ViewSpecificReturnAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSpecificReturnAddress do
  #let(:instance) { ClickSend::ViewSpecificReturnAddress.new }

  describe 'test an instance of ViewSpecificReturnAddress' do
    it 'should create an instance of ViewSpecificReturnAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSpecificReturnAddress)
    end
  end
