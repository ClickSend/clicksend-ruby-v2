...
# Unit tests for ClickSend::ViewSpecificSmsCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSpecificSmsCampaign do
  #let(:instance) { ClickSend::ViewSpecificSmsCampaign.new }

  describe 'test an instance of ViewSpecificSmsCampaign' do
    it 'should create an instance of ViewSpecificSmsCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSpecificSmsCampaign)
    end
  end
