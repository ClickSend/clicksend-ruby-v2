...
# Unit tests for ClickSend::ViewSpecificSmsReceipt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSpecificSmsReceipt do
  #let(:instance) { ClickSend::ViewSpecificSmsReceipt.new }

  describe 'test an instance of ViewSpecificSmsReceipt' do
    it 'should create an instance of ViewSpecificSmsReceipt' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSpecificSmsReceipt)
    end
  end
