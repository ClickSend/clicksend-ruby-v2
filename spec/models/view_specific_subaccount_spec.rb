...
# Unit tests for ClickSend::ViewSpecificSubaccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSpecificSubaccount do
  #let(:instance) { ClickSend::ViewSpecificSubaccount.new }

  describe 'test an instance of ViewSpecificSubaccount' do
    it 'should create an instance of ViewSpecificSubaccount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSpecificSubaccount)
    end
  end
