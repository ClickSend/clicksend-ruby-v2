...
# Unit tests for ClickSend::ViewSpecificTransaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSpecificTransaction do
  #let(:instance) { ClickSend::ViewSpecificTransaction.new }

  describe 'test an instance of ViewSpecificTransaction' do
    it 'should create an instance of ViewSpecificTransaction' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSpecificTransaction)
    end
  end
