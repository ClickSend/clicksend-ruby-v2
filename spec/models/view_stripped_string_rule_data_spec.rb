...
# Unit tests for ClickSend::ViewStrippedStringRuleData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewStrippedStringRuleData do
  #let(:instance) { ClickSend::ViewStrippedStringRuleData.new }

  describe 'test an instance of ViewStrippedStringRuleData' do
    it 'should create an instance of ViewStrippedStringRuleData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewStrippedStringRuleData)
    end
  end
  ...
  describe 'test attribute "stripped_string"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
