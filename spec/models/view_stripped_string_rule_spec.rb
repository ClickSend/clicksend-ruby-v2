...
# Unit tests for ClickSend::ViewStrippedStringRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewStrippedStringRule do
  #let(:instance) { ClickSend::ViewStrippedStringRule.new }

  describe 'test an instance of ViewStrippedStringRule' do
    it 'should create an instance of ViewStrippedStringRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewStrippedStringRule)
    end
  end
