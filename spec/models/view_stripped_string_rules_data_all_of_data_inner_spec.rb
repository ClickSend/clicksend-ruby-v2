...
# Unit tests for ClickSend::ViewStrippedStringRulesDataAllOfDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewStrippedStringRulesDataAllOfDataInner do
  #let(:instance) { ClickSend::ViewStrippedStringRulesDataAllOfDataInner.new }

  describe 'test an instance of ViewStrippedStringRulesDataAllOfDataInner' do
    it 'should create an instance of ViewStrippedStringRulesDataAllOfDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewStrippedStringRulesDataAllOfDataInner)
    end
  end
