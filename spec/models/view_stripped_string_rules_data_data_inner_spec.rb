...
# Unit tests for ClickSend::ViewStrippedStringRulesDataDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewStrippedStringRulesDataDataInner do
  #let(:instance) { ClickSend::ViewStrippedStringRulesDataDataInner.new }

  describe 'test an instance of ViewStrippedStringRulesDataDataInner' do
    it 'should create an instance of ViewStrippedStringRulesDataDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewStrippedStringRulesDataDataInner)
    end
  end
