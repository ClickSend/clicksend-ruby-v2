...
# Unit tests for ClickSend::ViewStrippedStringRulesData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewStrippedStringRulesData do
  #let(:instance) { ClickSend::ViewStrippedStringRulesData.new }

  describe 'test an instance of ViewStrippedStringRulesData' do
    it 'should create an instance of ViewStrippedStringRulesData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewStrippedStringRulesData)
    end
  end
