...
# Unit tests for ClickSend::ViewStrippedStringRules
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewStrippedStringRules do
  #let(:instance) { ClickSend::ViewStrippedStringRules.new }

  describe 'test an instance of ViewStrippedStringRules' do
    it 'should create an instance of ViewStrippedStringRules' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewStrippedStringRules)
    end
  end
