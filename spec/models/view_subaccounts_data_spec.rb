...
# Unit tests for ClickSend::ViewSubaccountsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSubaccountsData do
  #let(:instance) { ClickSend::ViewSubaccountsData.new }

  describe 'test an instance of ViewSubaccountsData' do
    it 'should create an instance of ViewSubaccountsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSubaccountsData)
    end
  end
