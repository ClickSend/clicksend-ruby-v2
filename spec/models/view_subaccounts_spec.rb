...
# Unit tests for ClickSend::ViewSubaccounts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewSubaccounts do
  #let(:instance) { ClickSend::ViewSubaccounts.new }

  describe 'test an instance of ViewSubaccounts' do
    it 'should create an instance of ViewSubaccounts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewSubaccounts)
    end
  end
