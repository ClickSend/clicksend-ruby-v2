...
# Unit tests for ClickSend::ViewTemplateCategoriesDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewTemplateCategoriesDataInner do
  #let(:instance) { ClickSend::ViewTemplateCategoriesDataInner.new }

  describe 'test an instance of ViewTemplateCategoriesDataInner' do
    it 'should create an instance of ViewTemplateCategoriesDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewTemplateCategoriesDataInner)
    end
  end
