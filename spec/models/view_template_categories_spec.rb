...
# Unit tests for ClickSend::ViewTemplateCategories
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewTemplateCategories do
  #let(:instance) { ClickSend::ViewTemplateCategories.new }

  describe 'test an instance of ViewTemplateCategories' do
    it 'should create an instance of ViewTemplateCategories' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewTemplateCategories)
    end
  end
