...
# Unit tests for ClickSend::ViewTemplateCategoryData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewTemplateCategoryData do
  #let(:instance) { ClickSend::ViewTemplateCategoryData.new }

  describe 'test an instance of ViewTemplateCategoryData' do
    it 'should create an instance of ViewTemplateCategoryData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewTemplateCategoryData)
    end
  end
