...
# Unit tests for ClickSend::ViewTemplateCategory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewTemplateCategory do
  #let(:instance) { ClickSend::ViewTemplateCategory.new }

  describe 'test an instance of ViewTemplateCategory' do
    it 'should create an instance of ViewTemplateCategory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewTemplateCategory)
    end
  end
