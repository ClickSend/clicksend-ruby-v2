...
# Unit tests for ClickSend::ViewTemplatesInCategory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewTemplatesInCategory do
  #let(:instance) { ClickSend::ViewTemplatesInCategory.new }

  describe 'test an instance of ViewTemplatesInCategory' do
    it 'should create an instance of ViewTemplatesInCategory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewTemplatesInCategory)
    end
  end
