...
# Unit tests for ClickSend::ViewVoiceDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewVoiceDeliveryReceiptRule do
  #let(:instance) { ClickSend::ViewVoiceDeliveryReceiptRule.new }

  describe 'test an instance of ViewVoiceDeliveryReceiptRule' do
    it 'should create an instance of ViewVoiceDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewVoiceDeliveryReceiptRule)
    end
  end
