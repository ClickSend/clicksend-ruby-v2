...
# Unit tests for ClickSend::ViewVoiceDeliveryReceiptRulesData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewVoiceDeliveryReceiptRulesData do
  #let(:instance) { ClickSend::ViewVoiceDeliveryReceiptRulesData.new }

  describe 'test an instance of ViewVoiceDeliveryReceiptRulesData' do
    it 'should create an instance of ViewVoiceDeliveryReceiptRulesData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewVoiceDeliveryReceiptRulesData)
    end
  end
