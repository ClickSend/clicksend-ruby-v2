...
# Unit tests for ClickSend::ViewVoiceDeliveryReceiptRules
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewVoiceDeliveryReceiptRules do
  #let(:instance) { ClickSend::ViewVoiceDeliveryReceiptRules.new }

  describe 'test an instance of ViewVoiceDeliveryReceiptRules' do
    it 'should create an instance of ViewVoiceDeliveryReceiptRules' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewVoiceDeliveryReceiptRules)
    end
  end
