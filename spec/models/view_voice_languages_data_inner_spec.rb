...
# Unit tests for ClickSend::ViewVoiceLanguagesDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewVoiceLanguagesDataInner do
  #let(:instance) { ClickSend::ViewVoiceLanguagesDataInner.new }

  describe 'test an instance of ViewVoiceLanguagesDataInner' do
    it 'should create an instance of ViewVoiceLanguagesDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewVoiceLanguagesDataInner)
    end
  end
