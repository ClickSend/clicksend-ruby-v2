...
# Unit tests for ClickSend::ViewVoiceLanguages
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewVoiceLanguages do
  #let(:instance) { ClickSend::ViewVoiceLanguages.new }

  describe 'test an instance of ViewVoiceLanguages' do
    it 'should create an instance of ViewVoiceLanguages' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewVoiceLanguages)
    end
  end
