...
# Unit tests for ClickSend::ViewVoiceReceiptsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewVoiceReceiptsData do
  #let(:instance) { ClickSend::ViewVoiceReceiptsData.new }

  describe 'test an instance of ViewVoiceReceiptsData' do
    it 'should create an instance of ViewVoiceReceiptsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewVoiceReceiptsData)
    end
  end
