...
# Unit tests for ClickSend::ViewVoiceReceipts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewVoiceReceipts do
  #let(:instance) { ClickSend::ViewVoiceReceipts.new }

  describe 'test an instance of ViewVoiceReceipts' do
    it 'should create an instance of ViewVoiceReceipts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewVoiceReceipts)
    end
  end
