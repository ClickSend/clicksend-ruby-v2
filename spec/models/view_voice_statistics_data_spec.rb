...
# Unit tests for ClickSend::ViewVoiceStatisticsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewVoiceStatisticsData do
  #let(:instance) { ClickSend::ViewVoiceStatisticsData.new }

  describe 'test an instance of ViewVoiceStatisticsData' do
    it 'should create an instance of ViewVoiceStatisticsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewVoiceStatisticsData)
    end
  end
