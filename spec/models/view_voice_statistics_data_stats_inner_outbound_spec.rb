...
# Unit tests for ClickSend::ViewVoiceStatisticsDataStatsInnerOutbound
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewVoiceStatisticsDataStatsInnerOutbound do
  #let(:instance) { ClickSend::ViewVoiceStatisticsDataStatsInnerOutbound.new }

  describe 'test an instance of ViewVoiceStatisticsDataStatsInnerOutbound' do
    it 'should create an instance of ViewVoiceStatisticsDataStatsInnerOutbound' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewVoiceStatisticsDataStatsInnerOutbound)
    end
  end
