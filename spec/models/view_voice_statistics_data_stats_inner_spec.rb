...
# Unit tests for ClickSend::ViewVoiceStatisticsDataStatsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewVoiceStatisticsDataStatsInner do
  #let(:instance) { ClickSend::ViewVoiceStatisticsDataStatsInner.new }

  describe 'test an instance of ViewVoiceStatisticsDataStatsInner' do
    it 'should create an instance of ViewVoiceStatisticsDataStatsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewVoiceStatisticsDataStatsInner)
    end
  end
