...
# Unit tests for ClickSend::ViewVoiceStatisticsDataTotalOutbound
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewVoiceStatisticsDataTotalOutbound do
  #let(:instance) { ClickSend::ViewVoiceStatisticsDataTotalOutbound.new }

  describe 'test an instance of ViewVoiceStatisticsDataTotalOutbound' do
    it 'should create an instance of ViewVoiceStatisticsDataTotalOutbound' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewVoiceStatisticsDataTotalOutbound)
    end
  end
