...
# Unit tests for ClickSend::ViewVoiceStatisticsDataTotal
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewVoiceStatisticsDataTotal do
  #let(:instance) { ClickSend::ViewVoiceStatisticsDataTotal.new }

  describe 'test an instance of ViewVoiceStatisticsDataTotal' do
    it 'should create an instance of ViewVoiceStatisticsDataTotal' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewVoiceStatisticsDataTotal)
    end
  end
