...
# Unit tests for ClickSend::ViewVoiceStatistics
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewVoiceStatistics do
  #let(:instance) { ClickSend::ViewVoiceStatistics.new }

  describe 'test an instance of ViewVoiceStatistics' do
    it 'should create an instance of ViewVoiceStatistics' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewVoiceStatistics)
    end
  end
