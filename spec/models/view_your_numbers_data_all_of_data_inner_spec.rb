...
# Unit tests for ClickSend::ViewYourNumbersDataAllOfDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewYourNumbersDataAllOfDataInner do
  #let(:instance) { ClickSend::ViewYourNumbersDataAllOfDataInner.new }

  describe 'test an instance of ViewYourNumbersDataAllOfDataInner' do
    it 'should create an instance of ViewYourNumbersDataAllOfDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewYourNumbersDataAllOfDataInner)
    end
  end
  ...
  describe 'test attribute "_country_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "number_category"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "number_guid"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "form_submission_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
