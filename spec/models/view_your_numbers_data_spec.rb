...
# Unit tests for ClickSend::ViewYourNumbersData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewYourNumbersData do
  #let(:instance) { ClickSend::ViewYourNumbersData.new }

  describe 'test an instance of ViewYourNumbersData' do
    it 'should create an instance of ViewYourNumbersData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewYourNumbersData)
    end
  end
