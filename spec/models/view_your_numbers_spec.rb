...
# Unit tests for ClickSend::ViewYourNumbers
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewYourNumbers do
  #let(:instance) { ClickSend::ViewYourNumbers.new }

  describe 'test an instance of ViewYourNumbers' do
    it 'should create an instance of ViewYourNumbers' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewYourNumbers)
    end
  end
