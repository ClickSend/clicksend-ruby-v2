...
# Unit tests for ClickSend::ViewYourReturnAddressesData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewYourReturnAddressesData do
  #let(:instance) { ClickSend::ViewYourReturnAddressesData.new }

  describe 'test an instance of ViewYourReturnAddressesData' do
    it 'should create an instance of ViewYourReturnAddressesData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewYourReturnAddressesData)
    end
  end
