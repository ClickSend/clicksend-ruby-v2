...
# Unit tests for ClickSend::ViewYourReturnAddresses
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::ViewYourReturnAddresses do
  #let(:instance) { ClickSend::ViewYourReturnAddresses.new }

  describe 'test an instance of ViewYourReturnAddresses' do
    it 'should create an instance of ViewYourReturnAddresses' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::ViewYourReturnAddresses)
    end
  end
