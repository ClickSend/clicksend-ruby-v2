...
# Unit tests for ClickSend::VoiceDeliveryReceiptRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::VoiceDeliveryReceiptRule do
  #let(:instance) { ClickSend::VoiceDeliveryReceiptRule.new }

  describe 'test an instance of VoiceDeliveryReceiptRule' do
    it 'should create an instance of VoiceDeliveryReceiptRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::VoiceDeliveryReceiptRule)
    end
  end
