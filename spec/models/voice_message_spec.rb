...
# Unit tests for ClickSend::VoiceMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::VoiceMessage do
  #let(:instance) { ClickSend::VoiceMessage.new }

  describe 'test an instance of VoiceMessage' do
    it 'should create an instance of VoiceMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::VoiceMessage)
    end
  end
