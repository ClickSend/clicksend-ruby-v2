...
# Unit tests for ClickSend::VoiceReceipt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClickSend::VoiceReceipt do
  #let(:instance) { ClickSend::VoiceReceipt.new }

  describe 'test an instance of VoiceReceipt' do
    it 'should create an instance of VoiceReceipt' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClickSend::VoiceReceipt)
    end
  end
